...
import com.wl4g.dopaas.umc.console.ReceiverConsole;
import com.wl4g.dopaas.umc.receiver.HttpMetricReceiver;
import com.wl4g.dopaas.umc.receiver.KafkaMetricReceiver;
import com.wl4g.dopaas.umc.store.MetricStore;
...
public class UmcReceiveAutoConfiguration extends PrefixHandlerMappingSupport {
	...
	public Object httpCollectReceiverPrefixHandlerMapping() {
		return super.newPrefixHandlerMapping(URI_HTTP_RECEIVER_BASE, com.wl4g.dopaas.umc.annotation.HttpCollectReceiver.class);
	}
