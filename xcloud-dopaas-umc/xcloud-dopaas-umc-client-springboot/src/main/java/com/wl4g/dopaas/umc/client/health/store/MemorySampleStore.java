...
import com.wl4g.dopaas.umc.client.health.indicator.BaseHealthIndicator.Partition;
 ...
 * @since
 */
public class MemorySampleStore implements SampleStore<Partition> {
    private final static Logger logger = LoggerFactory.getLogger(MemorySampleStore.class);

    /**
     * Default number of retained samples.
     */
    public static final int DEFAULT_CAPACITY = 32;
    public static final int MAX_CAPACITY = DEFAULT_CAPACITY * 20;
    public static final long DEFAULT_RETAIN = 5 * 60 * 1000;
    public static final long MAX_RETAIN = DEFAULT_RETAIN * 5;

    private final LinkedList<Partition> records = new LinkedList<>();
    private int capacity = DEFAULT_CAPACITY;
    private long retainTime = DEFAULT_RETAIN;

    public MemorySampleStore(int capacity, long retainTime) {
