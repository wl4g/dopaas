...
import com.wl4g.paas.common.bean.umc.MetricTemplate;
import com.wl4g.paas.umc.service.MetricTemplateService;
...
public class MetricTemplateController extends BaseController {
	...
	public RespBase<?> list(String metric, String classify, PageHolder<MetricTemplate> pm) {
