...
import com.wl4g.paas.umc.opentsdb.client.bean.response.DetailResult;
import com.wl4g.paas.umc.opentsdb.client.http.callback.BatchPutHttpResponseCallback.BatchPutCallBack;
...
import static com.wl4g.paas.umc.opentsdb.client.OpenTSDBClientFactory.connect;
import static com.wl4g.paas.umc.opentsdb.client.OpenTSDBConfig.address;
