...
import static com.wl4g.paas.common.constant.UMCConstants.URI_HTTP_RECEIVER_BASE;
import static com.wl4g.paas.umc.config.ReceiverProperties.KEY_RECEIVER_PREFIX;
import static com.wl4g.paas.umc.config.UmcAlarmAutoConfiguration.BEAN_DEFAULT_VALVE_ALERTER;
...
import com.wl4g.paas.umc.annotation.EnableHttpCollectReceiver;
import com.wl4g.paas.umc.annotation.EnableKafkaCollectReceiver;
import com.wl4g.paas.umc.console.ReceiverConsole;
import com.wl4g.paas.umc.receiver.HttpMetricReceiver;
import com.wl4g.paas.umc.receiver.KafkaMetricReceiver;
...
public class UmcReceiveAutoConfiguration extends PrefixHandlerMappingSupport {
	...
	public Object httpCollectReceiverPrefixHandlerMapping() {
		return super.newPrefixHandlerMapping(URI_HTTP_RECEIVER_BASE, com.wl4g.paas.umc.annotation.HttpCollectReceiver.class);
	}
	...
	@Bean
	public ReceiverConsole receiveConsole() {
		return new ReceiverConsole();
	}
