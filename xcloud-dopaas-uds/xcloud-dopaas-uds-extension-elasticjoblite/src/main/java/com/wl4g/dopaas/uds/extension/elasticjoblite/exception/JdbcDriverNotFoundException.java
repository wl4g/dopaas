...
package com.wl4g.dopaas.uds.extension.elasticjoblite.exception;
...
public final class JdbcDriverNotFoundException extends RuntimeException {
	...
	public JdbcDriverNotFoundException(final String message) {
		super(String.format(
				"Class not found: [%s]. Consider manually adding JDBC driver JAR to library path if you are trying connecting database.",
				message));
	}
}
