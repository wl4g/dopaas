...
package com.wl4g.dopaas.uds.extension.elasticjoblite.dao.statistics;

import com.wl4g.dopaas.uds.extension.elasticjoblite.domain.TaskResultStatistics;
...
public interface TaskResultStatisticsRepository extends JpaRepository<TaskResultStatistics, Long> {
	...
	List<TaskResultStatistics> findTaskResultStatistics(@Param("fromTime") Date fromTime,
			@Param("statisticInterval") String statisticInterval);
	...
	TaskResultStatistics getSummedTaskResultStatistics(@Param("fromTime") Date fromTime,
			@Param("statisticInterval") String statisticInterval);
}
