...
package com.wl4g.dopaas.uds.extension.elasticjoblite.util;
...
public final class SessionEventTraceDataSourceConfiguration {
	...
	public static void setDataSourceConfiguration(final EventTraceDataSourceConfig eventTraceDataSourceConfiguration) {
		DynamicDSAutoConfiguration.DynamicDataSourceContextHolder.setDataSourceName(eventTraceDataSourceConfiguration.getName());
