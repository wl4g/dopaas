...
package com.wl4g.dopaas.uds.extension.elasticjoblite.domain;
...
public class JobStatusTraceLog {
	...
	public JobStatusTraceEvent toJobStatusTraceEvent() {
		return new JobStatusTraceEvent(id, jobName, originalTaskId, taskId, slaveId, JobStatusTraceEvent.Source.valueOf(source),
				executionType, shardingItem, JobStatusTraceEvent.State.valueOf(state), message, creationTime);
	}
