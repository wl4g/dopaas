...
public interface CloudRegistryCenterConfigService {
	...
	RegistryCenterConfig load(@RequestParam("name") String name);
	...
	RegistryCenterConfig find(@RequestParam("name") String name, @RequestBody RegistryCenterConfigs configs);
