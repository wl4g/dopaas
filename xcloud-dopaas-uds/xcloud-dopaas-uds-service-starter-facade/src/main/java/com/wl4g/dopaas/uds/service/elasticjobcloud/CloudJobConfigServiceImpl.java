...
public final class CloudJobConfigServiceImpl implements CloudJobConfigService {
	...
	public void add(final CloudJobConfigurationPOJO cloudJobConfig) {
		regCenter.persist(CloudJobConfigurationNode.getRootNodePath(cloudJobConfig.getJobName()),
	...
	public void update(final CloudJobConfigurationPOJO cloudJobConfig) {
		regCenter.update(CloudJobConfigurationNode.getRootNodePath(cloudJobConfig.getJobName()),
				YamlEngine.marshal(cloudJobConfig));
	}
	...
	static final class CloudJobConfigurationNode {
