...
import com.wl4g.dopaas.uds.elasticjob.service.JobAPIService;
import com.wl4g.dopaas.uds.elasticjob.util.SessionRegistryCenterConfiguration;
...
public final class ServerOperationController {
	...
	public ResponseResult<Boolean> disableServerJob(@PathVariable("serverIp") final String serverIp,
	...
	public ResponseResult<Boolean> enableServerJob(@PathVariable("serverIp") final String serverIp,
			@PathVariable("jobName") final String jobName) {
	...
	public ResponseResult<Boolean> shutdownServerJob(@PathVariable("serverIp") final String serverIp,
			@PathVariable("jobName") final String jobName) {
	...
	public ResponseResult<Boolean> removeServerJob(@PathVariable("serverIp") final String serverIp,
			@PathVariable("jobName") final String jobName) {
