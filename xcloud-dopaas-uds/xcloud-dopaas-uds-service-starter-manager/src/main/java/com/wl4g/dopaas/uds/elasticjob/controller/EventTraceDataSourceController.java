...
import com.wl4g.dopaas.uds.elasticjob.domain.EventTraceDataSourceFactory;
...
public final class EventTraceDataSourceController {
	...
	public ResponseResult<Collection<EventTraceDataSourceConfiguration>> load(final HttpServletRequest request) {
		...
		return ResponseResultUtil
				.build(eventTraceDataSourceConfigurationService.loadAll().getEventTraceDataSourceConfiguration());
	}
	...
	public ResponseResult<Boolean> connectTest(@RequestBody final EventTraceDataSourceConfiguration config,
	...
	public ResponseResult<Boolean> connect(@RequestBody final EventTraceDataSourceConfiguration config,
			final HttpServletRequest request) {
