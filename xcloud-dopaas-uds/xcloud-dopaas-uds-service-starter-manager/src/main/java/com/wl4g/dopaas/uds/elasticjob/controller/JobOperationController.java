...
public final class JobOperationController {
	...
	public ResponseResult<Boolean> disableSharding(@PathVariable("jobName") final String jobName,
	...
	public ResponseResult<Boolean> enableSharding(@PathVariable("jobName") final String jobName,
			@PathVariable("item") final String item) {
