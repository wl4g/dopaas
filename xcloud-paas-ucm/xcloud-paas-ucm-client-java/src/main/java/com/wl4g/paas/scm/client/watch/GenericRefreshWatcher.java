...
import com.wl4g.paas.scm.client.config.ScmClientProperties;
import com.wl4g.paas.scm.client.event.ConfigEventListener;
import com.wl4g.paas.scm.client.event.ScmEventPublisher;
import com.wl4g.paas.scm.client.event.ScmEventSubscriber;
import com.wl4g.paas.scm.client.repository.RefreshRecordsRepository;
import com.wl4g.paas.scm.client.repository.ReleaseConfigSourceWrapper;
import com.wl4g.paas.scm.client.utils.NodeHolder;
import com.wl4g.paas.scm.common.config.ScmConfigSource;
import com.wl4g.paas.scm.common.config.resolve.DefaultPropertySourceResolver;
import com.wl4g.paas.scm.common.config.resolve.PropertySourceResolver;
import com.wl4g.paas.scm.common.exception.ScmException;
import com.wl4g.paas.scm.common.model.FetchReleaseConfigRequest;
import com.wl4g.paas.scm.common.model.ReleaseConfigInfo;
import com.wl4g.paas.scm.common.model.ReleaseConfigInfo.ReleaseContent;

import static com.wl4g.component.common.collection.CollectionUtils2.safeList;
import static com.wl4g.component.common.lang.Assert2.notNull;
import static com.wl4g.component.common.lang.Assert2.notNullOf;
import static com.wl4g.component.common.lang.ThreadUtils2.sleep;
import static com.wl4g.paas.scm.common.SCMConstants.*;
