...
public class PhysicalStatInfo extends Base {
	...
	public PhysicalStatInfo() {

	}

	public PhysicalStatInfo(Double[] cpu, DiskInfo[] diskInfos, MemInfo memInfo, NetInfo[] netInfos) {
		this.cpu = cpu;
