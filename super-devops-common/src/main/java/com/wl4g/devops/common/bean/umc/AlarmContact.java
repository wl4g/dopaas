...
public class AlarmContact extends BaseBean implements Serializable {
	...
	public String toString() {
		return "AlarmContact{" + "name='" + name + '\'' + ", email='" + email + '\'' + ", phone='" + phone + '\'' + ", dingtalk='"
				+ dingtalk + '\'' + ", wechat='" + wechat + '\'' + ", twitter='" + twitter + '\'' + ", facebook='" + facebook
				+ '\'' + ", emailEnable=" + emailEnable + ", phoneEnable=" + phoneEnable + ", dingtalkEnable=" + dingtalkEnable
				+ ", wechatEnable=" + wechatEnable + ", twitterEnable=" + twitterEnable + ", facebookEnable=" + facebookEnable
				+ ", phoneTimeOfFreq=" + phoneTimeOfFreq + ", dingtalkTimeOfFreq=" + dingtalkTimeOfFreq + ", wechatTimeOfFreq="
				+ wechatTimeOfFreq + ", twitterTimeOfFreq=" + twitterTimeOfFreq + ", facebookTimeOfFreq=" + facebookTimeOfFreq
				+ ", phoneNumOfFreq=" + phoneNumOfFreq + ", dingtalkNumOfFreq=" + dingtalkNumOfFreq + ", wechatNumOfFreq="
				+ wechatNumOfFreq + ", twitterNumOfFreq=" + twitterNumOfFreq + ", facebookNumOfFreq=" + facebookNumOfFreq
