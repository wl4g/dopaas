 ...
 */
package com.wl4g.devops.common.exception.djob;
...
public class DjobException extends DevOpsException {
	 ...
	 */
	public DjobException(String message) {
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public DjobException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @since 1.4
	 */
	public DjobException(Throwable cause) {
		super(cause);
	}
