 ...
 */
package com.wl4g.devops.uos.server.config;
...
import com.wl4g.devops.uos.server.CossServer;
import com.wl4g.devops.uos.server.CossServerBootsstrap;
import com.wl4g.devops.uos.server.NettyCossServer;
import com.wl4g.devops.uos.server.handler.CossActionProvider;
import com.wl4g.devops.uos.server.handler.DefaultCossActionProvider;
...
public class ChannelServerAutoConfiguration {
	...
	@Bean
	public CossServerBootsstrap uosServerBootsstrap(ChannelServerProperties config, List<CossServer> servers) {
