 ...
 */
package com.wl4g.devops.uos.aliyun.config;
...
import com.wl4g.devops.uos.aliyun.OssCossEndpoint;

@Configuration
public class AliyunOssAutoConfiguration {
	final public static String KEY_OSS_PREFIX = "spring.cloud.devops.uos.aliyunoss";
