...
import com.wl4g.devops.uos.client.utils.HttpUtil;
import com.wl4g.devops.uos.common.auth.RequestSigner;
import com.wl4g.devops.uos.common.exception.ClientCossException;
import com.wl4g.devops.uos.common.exception.ServiceException;
import com.wl4g.devops.uos.common.internal.ExecutionContext;
import com.wl4g.devops.uos.common.internal.HttpMesssage;
import com.wl4g.devops.uos.common.internal.RequestHandler;
import com.wl4g.devops.uos.common.internal.RequestMessage;
import com.wl4g.devops.uos.common.internal.ResponseHandler;
...
import com.wl4g.devops.uos.common.utils.HttpMethod;
import com.wl4g.devops.uos.common.utils.LogUtils;

import static com.wl4g.devops.uos.common.utils.LogUtils.getLog;
import static com.wl4g.components.common.lang.Assert2.notNull;
import static com.wl4g.devops.uos.client.utils.UOSUtils.COMMON_RESOURCE_MANAGER;
import static com.wl4g.devops.uos.common.utils.LogUtils.logException;

/**
 * Abstract channel client that provides interfaces to access UOS services.
 */
public abstract class ChannelClient {
	...
	/**
	 * Send HTTP request with specified context to UOS and wait for HTTP
	 * response.
	 */
	...
	/**
	 * Do implements the core logic to send requests to UOS services.
	 * 
	 * @param request
	 * @param context
	 * @return
	...
	private ResponseMessage doRequest(RequestMessage request, ExecutionContext context)
		...
		if (requestContent != null && requestContent.markSupported()) {
			requestContent.mark(UOSConstants.DEFAULT_STREAM_BUFFER_SIZE);
		}
		...
		while (true) {
			try {
				...
				// Step 3. Send HTTP request to UOS.
	...
	/**
	 * Implements the core logic to send requests to UOS services.
	 */
