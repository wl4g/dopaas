 ...
 */
package com.wl4g.devops.uos.aws.config;
...
import com.wl4g.devops.uos.aws.S3CossEndpoint;

@Configuration
public class S3CossAutoConfiguration {
	final public static String KEY_PROPERTY_PREFIX = "spring.cloud.devops.uos.s3";
