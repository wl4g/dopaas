...
import com.wl4g.devops.uos.common.internal.SignParameters;

import static com.wl4g.devops.uos.common.internal.SignParameters.*;
...
//					} else if (lowerKey.startsWith(UOSHeaders.OSS_PREFIX)) {
...
//			requestMessage.addHeader(UOSHeaders.OSS_USER_METADATA_PREFIX + h.getKey(), h.getValue());
//		}
