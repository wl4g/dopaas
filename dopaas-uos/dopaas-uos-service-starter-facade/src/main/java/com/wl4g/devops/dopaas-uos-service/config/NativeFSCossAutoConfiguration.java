...
import com.wl4g.devops.uos.natives.NativeFSCossEndpoint;
 ...
 */
@Configuration
public class NativeFSCossAutoConfiguration {
	final public static String KEY_PROPERTY_PREFIX = "spring.cloud.devops.uos.native";
	...
	public NativeFSCossEndpoint nativeCossEndpoint(NativeFSCossProperties config) {
		return new NativeFSCossEndpoint(config);
	}
