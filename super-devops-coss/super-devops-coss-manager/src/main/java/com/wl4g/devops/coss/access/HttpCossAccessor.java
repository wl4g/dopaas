...
public class HttpCossAccessor extends BaseController {
    ...
    public void findfile(HttpServletRequest request, HttpServletResponse response, GenericCossParameter param, String bucketName, String key) throws IOException {
