...
//
///**
// * Abstract service client that provides interfaces to access COSS services.
// */
//public abstract class NetworkClient {
//
//	final protected ClientCossConfiguration config;
//
//	protected NetworkClient(ClientCossConfiguration config) {
//		this.config = config;
//	}
//
...
//
//	/**
//	 * Implements the core logic to send requests to Aliyun COSS services.
//	 */
