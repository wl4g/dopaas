      ...
      iam: # IAM server configuration.
        ...
        sns: # SNS configuration.
          ...
          wechat-mp:
            ...
            redirect-url: https://iam.${r'${'}X_SERVICE_ZONE:wl4g.fat}${r'${'}server.servlet.contextPath}/sns/wechatmp/callback
          wechat:
            app-id: yourappid
            app-secret: yoursecret
            redirect-url: http://passport.wl4g.fat${r'${'}server.servlet.contextPath}/sns/wechat/callback
            href: https://${r'${'}X_SERVICE_ZONE:wl4g.fat}/${r'${'}server.servlet.contextPath}/iam-jssdk/assets/css/iam-jssdk-wx.min.css
          qq:
            app-id: 101542056
            app-secret: 46b2ba9fa24c2b973abc64ec898db3b4
            redirect-url: http://passport.wl4g.fat${r'${'}server.servlet.contextPath}/sns/qq/callback
</#if>
