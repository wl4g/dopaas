...
INSERT INTO `sys_cluster_config` VALUES (39, ${clusterId}, '${serverName}', ${projectOfClusterType}, 'dev', 'http://${organName?lower_case}.debug:38080', '${organName?lower_case}.debug:28080/${serverName}', 'http://localhost:28080/${serverName}', '${projectName?lower_case} service', NULL, NULL, NULL, NULL, 0);
