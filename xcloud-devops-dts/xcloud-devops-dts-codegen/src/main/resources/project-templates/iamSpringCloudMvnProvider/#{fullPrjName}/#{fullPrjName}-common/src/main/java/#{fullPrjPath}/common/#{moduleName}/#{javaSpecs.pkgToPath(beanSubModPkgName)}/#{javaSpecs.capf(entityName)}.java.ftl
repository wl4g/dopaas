...
package ${organType}.${organName}.${projectName}.common.${moduleName}.${beanSubModPkgName};

<#if javaSpecs.isConfOr(extOpts, "swagger.ui", "officialOas", "bootstrapSwagger2")>
...
<#assign isExportExcel = javaSpecs.isConf(tExtOpts, "tab.export-excel", "true")>
