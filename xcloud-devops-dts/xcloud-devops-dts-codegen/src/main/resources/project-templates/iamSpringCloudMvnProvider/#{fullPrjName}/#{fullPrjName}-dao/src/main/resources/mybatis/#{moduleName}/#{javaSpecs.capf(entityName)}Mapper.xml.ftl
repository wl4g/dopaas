...
<mapper namespace="${packageName}.${daoSubModPkgName}.${entityName?cap_first}Dao">
    <resultMap id="BaseResultMap" type="${organType}.${organName}.${projectName}.common.${moduleName}.${beanSubModPkgName}.${entityName?cap_first}">
    ...
    <insert id="insertSelective" parameterType="${organType}.${organName}.${projectName}.common.${moduleName}.${beanSubModPkgName}.${entityName?cap_first}">
    ...
    <update id="updateByPrimaryKeySelective" parameterType="${organType}.${organName}.${projectName}.common.${moduleName}.${beanSubModPkgName}.${entityName?cap_first}">
        UPDATE ${tableName}
        <set>
        <#list genTableColumns as param>
            <if test="${param.attrName} != null">
    ...
    <update id="updateByPrimaryKey" parameterType="${organType}.${organName}.${projectName}.common.${moduleName}.${beanSubModPkgName}.${entityName?cap_first}">
        UPDATE ${tableName}
        <set>
        <#list genTableColumns as param>
            ${param.columnName} = ${r'#{'}${param.attrName}, jdbcType=${param.sqlType}},
    ...
    <select id="list" resultMap="BaseResultMap" parameterType="${organType}.${organName}.${projectName}.common.${moduleName}.${beanSubModPkgName}.${entityName?cap_first}" >
        ...
        FROM ${tableName}
        <where>
            <#if javaSpecs.isConf(tExtOpts, "tab.del-type", "deleteWithLogical")>
                AND del_flag != 1
            </#if>
            <#list genTableColumns as param>
            <#if param.isQuery == 1>
