  ...
  cloud:
    devops:
      iam:
        ...
        client:
          server-uri: http://iam.${r'${'}X_SERVICE_ZONE:wl4g.uat}/iam-server
          unauthorized-uri: ${r'${'}spring.cloud.devops.iam.client.server-uri}/view/403.html
          success-uri: http://devops.${r'${'}X_SERVICE_ZONE:wl4g.uat}/#/share
  # Datasource configuration.
  datasource:
    type: com.alibaba.druid.pool.DruidDataSource
    driverClassName: com.mysql.jdbc.Driver
    druid:
      url: jdbc:mysql://${r'${'}X_DB_URL:wl4g.uat:3306}/${r'${'}X_DB_NAME:devops}?useUnicode=true&characterEncoding=utf-8&useSSL=false
...
redis:
  ...
  nodes: ${r'${'}X_REDIS_NODES:wl4g.uat:6379,wl4g.uat:6380,wl4g.uat:6381,owner-node3:7379,owner-node3:7380,owner-node3:7381}
