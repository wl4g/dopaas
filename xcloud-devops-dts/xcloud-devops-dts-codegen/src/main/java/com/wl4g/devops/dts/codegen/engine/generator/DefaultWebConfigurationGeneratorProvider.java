...
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_DEV_REDIS_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_DEV_SERVICE_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_DEV_TOPDOMAIN;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_DEV_VIEW_SERVICE_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_DEV_VIEW_SERVICE_PORT;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_ENTRYAPP_NAME;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_ENTRYAPP_PORT;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_FAT_MYSQL_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_FAT_ORACLE_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_FAT_POSTGRE_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_FAT_REDIS_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_FAT_SERVICE_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_FAT_TOPDOMAIN;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_FAT_VIEW_SERVICE_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_PRO_MYSQL_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_PRO_ORACLE_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_PRO_POSTGRE_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_PRO_REDIS_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_PRO_SERVICE_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_PRO_TOPDOMAIN;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_PRO_VIEW_SERVICE_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_UAT_MYSQL_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_UAT_ORACLE_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_UAT_POSTGRE_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_UAT_REDIS_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_UAT_SERVICE_HOST;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_UAT_TOPDOMAIN;
import static com.wl4g.devops.dts.codegen.utils.ModelAttributeDefinitions.GEN_DEF_UAT_VIEW_SERVICE_HOST;
import static java.util.Locale.US;

import java.util.Map;

/**
 * {@link DefaultWebConfigurationGeneratorProvider}
 * 
 ...
 * @see
 */
public abstract class DefaultWebConfigurationGeneratorProvider extends AbstractGeneratorProvider {

	public DefaultWebConfigurationGeneratorProvider(@NotNull GenerateContext context,
