...
public class UcmContextRefresher extends ContextRefresher {
    ...
    private ConfigurableApplicationContext addUcmConfigToEnvironment() {
        ...
        try {
            ...
            capture = builder.run();
            if (environment.getPropertySources().contains(UCM_REFRESH_PROPERTY_SOURCE)) {
                environment.getPropertySources().remove(UCM_REFRESH_PROPERTY_SOURCE);
            }
    ...
    private StandardEnvironment copyEnvironment(ConfigurableEnvironment input) {
        ...
        capturedPropertySources.addFirst(new MapPropertySource(UCM_REFRESH_PROPERTY_SOURCE, map));
        return environment;
    }
