...
public class WatchDeferredResult<T> extends DeferredResult<T> implements Serializable {
    ...
    private ReleaseConfigInfoRequest watch;
    ...
    public WatchDeferredResult(Long timeout, ReleaseConfigInfoRequest watch) {
        super(timeout);
        this.watch = watch;
    }

    public ReleaseConfigInfoRequest getWatch() {
        return watch;
    }

    public WatchDeferredResult<T> setWatch(ReleaseConfigInfoRequest get) {
        this.watch = get;
        return this;
    }
