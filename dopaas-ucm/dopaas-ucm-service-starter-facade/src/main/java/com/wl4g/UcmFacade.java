...
@EnableShellServer
@EnableFeignConsumers({ "com.wl4g.dopaas.ucm.service", "com.wl4g.iam.service" })
@EnableComponentDataConfiguration("com.wl4g.dopaas.ucm.data")
@SpringBootApplication
public class UcmFacade {

    public static void main(String[] args) {
        SpringApplication.run(UcmFacade.class, args);
    }
