...
import com.wl4g.infra.core.utils.PropertySources.ConfigType;
...
public class StandardConfigServerHandler implements CentralConfigServerHandler {
    ...
    // WatchCommandResult release = new WatchCommandResult(get.getCluster(),
    // get.getNamespaces(), get.getMeta(), get.getNode());
    //
    ...
    // config.getContents().forEach(vc ->
    // release.getPropertySources().add(convertReleasePropertySource(vc)));
    // }
    // }
    //
    // return release;
     ...
     * @return
     */
    private ConfigSource convertReleasePropertySource(VersionContentBean vc) {
        ...
        Map<String, Object> sourceMap = PropertySources.resolve(ConfigType.of(fileType), vc.getContent());
        return new ConfigSource(filename, sourceMap);
    }
