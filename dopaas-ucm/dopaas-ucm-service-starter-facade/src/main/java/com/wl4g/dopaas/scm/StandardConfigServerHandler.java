...
import com.wl4g.dopaas.ucm.common.model.ReleaseConfigInfo.ReleaseContent;
...
public class StandardConfigServerHandler implements CentralConfigServerHandler {
    ...
    private ReleaseContent convertReleasePropertySource(VersionContentBean vc) {
        ...
        Map<String, Object> source = PropertySources.resolve(ConfigType.of(fileType), vc.getContent());
