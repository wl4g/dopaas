...
import com.wl4g.dopaas.UcmServer;
import com.wl4g.dopaas.common.bean.ucm.model.PreRelease;
import com.wl4g.dopaas.support.redis.JedisService;
...
@SpringBootTest(classes = UcmServer.class)
...
public class DefaultRedisConfigSourcePublisherTests {
    ...
    public void setObjectTTest() {
        ...
        wrapper.setCluster("ucm-example");
        ...
        String s = jedisService.setObjectT("ucm_pub_config_ucm-example", user, 0);
    ...
    public void setObjectAsJsonTest() {
        DefaultRedisConfigSourcePublisher.PublishConfigWrapper wrapper = new DefaultRedisConfigSourcePublisher.PublishConfigWrapper();
        wrapper.setCluster("ucm-example");
        jedisService.setObjectAsJson("ucm_pub_config_ucm-example", wrapper, 0);
    }
