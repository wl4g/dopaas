...
public class UcmServerEndpointTests {
     ...
     * The full demo needs to start UCM example.
     * 
     * @return
     */
    @Test
    public void manualReleaseTests() {
        ...
        // For simulation continuous running of UCM server
