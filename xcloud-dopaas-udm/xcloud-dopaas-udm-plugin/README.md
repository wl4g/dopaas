## XCloud DoPaaS Doc Plugin for Swagger
...
<build>
    <plugins>
        ...
        <plugin>
            ...
            <artifactId>xcloud-dopaas-doc-plugin-swagger</artifactId>
            ...
            <executions>
                <execution>
                    ...
                    <configuration>
                        ...
                        <!-- default is empty -->
                        <resourcePackages>
                            <resourcePackage>com.wl4g.dopaas.doc.plugin.sample.article</resourcePackage>
                            <resourcePackage>com.wl4g.dopaas.doc.plugin.sample.sys</resourcePackage>
                        </resourcePackages>
...
> Example codes reference to: [xcloud-dopaas-doc-plugin-sample/pom.xml](xcloud-dopaas-doc-plugin-sample/pom.xml)
