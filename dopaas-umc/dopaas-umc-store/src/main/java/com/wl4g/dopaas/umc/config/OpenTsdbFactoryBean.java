...
import com.wl4g.dopaas.umc.opentsdb.client.OpenTSDBClient;
import com.wl4g.dopaas.umc.opentsdb.client.bean.request.Point;
import com.wl4g.dopaas.umc.opentsdb.client.bean.response.DetailResult;
import com.wl4g.dopaas.umc.opentsdb.client.http.callback.BatchPutHttpResponseCallback.BatchPutCallBack;
...
import static com.wl4g.dopaas.umc.opentsdb.client.OpenTSDBClientFactory.connect;
import static com.wl4g.dopaas.umc.opentsdb.client.OpenTSDBConfig.address;
