...
import com.wl4g.dopaas.umc.alarm.alerting.DefaultIndicatorsValveAlerter;
import com.wl4g.dopaas.umc.alarm.alerting.IndicatorsValveAlerter;
import com.wl4g.dopaas.umc.alarm.alerting.SimulateIndicatorsValveAleter;
import com.wl4g.dopaas.umc.console.AlarmConsole;
import com.wl4g.dopaas.umc.handler.CheckImpledAlarmConfigurer;
import com.wl4g.dopaas.umc.handler.AlarmConfigurer;
import com.wl4g.dopaas.umc.rule.RuleConfigManager;
import com.wl4g.dopaas.umc.rule.inspect.AvgRuleInspector;
import com.wl4g.dopaas.umc.rule.inspect.CompositeRuleInspectorAdapter;
import com.wl4g.dopaas.umc.rule.inspect.LatestRuleInspector;
import com.wl4g.dopaas.umc.rule.inspect.MaxRuleInspector;
import com.wl4g.dopaas.umc.rule.inspect.MinRuleInspector;
import com.wl4g.dopaas.umc.rule.inspect.RuleInspector;
import com.wl4g.dopaas.umc.rule.inspect.SumRuleInspector;
