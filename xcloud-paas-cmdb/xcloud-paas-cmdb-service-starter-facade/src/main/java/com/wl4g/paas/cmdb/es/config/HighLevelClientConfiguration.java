 ...
 */
package com.wl4g.paas.cmdb.es.config;

import com.wl4g.paas.cmdb.es.EnhancedRestHighLevelClient;
import com.wl4g.paas.cmdb.es.config.ElasticsearchClientProperties.ElasticsearchClientPoolProperties;
import com.wl4g.paas.cmdb.es.pool.ElasticsearchClientFactory;
import com.wl4g.paas.cmdb.es.pool.ElasticsearchClientPool;
