...
class RpcScmClient extends GenericScmClient {
	...
	public RpcScmClient(ScmClientProperties<?> config, RefreshConfigStore store, ConfigEventListener... listeners) {
		super(new RpcRefreshWatcher(config, store, listeners));
	}
