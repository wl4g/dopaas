...
import com.wl4g.devops.uos.common.utils.SignUtils;
...
//				request.addHeader(UOSHeaders.AUTHORIZATION,
//						SignUtils.composeRequestAuthorization(accessKeyId, signature, request));
			} else {
				//TODO
//				signature = SignUtils.buildSignature(secretAccessKey, httpMethod, resourcePath, request);
//				request.addHeader(UOSHeaders.AUTHORIZATION, SignUtils.composeRequestAuthorization(accessKeyId, signature));
			}
		}
	}
