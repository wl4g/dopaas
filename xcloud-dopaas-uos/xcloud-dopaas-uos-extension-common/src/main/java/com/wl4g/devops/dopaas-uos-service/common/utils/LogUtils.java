...
public class LogUtils {
	...
	private static final Log log = LogFactory.getLog("com.wl4g.devops.uos");
	...
	static {
		errorCodeFilterList.add(UOSResultCode.NO_SUCH_BUCKET);
		errorCodeFilterList.add(UOSResultCode.NO_SUCH_KEY);
		errorCodeFilterList.add(UOSResultCode.NO_SUCH_UPLOAD);
		errorCodeFilterList.add(UOSResultCode.NO_SUCH_CORS_CONFIGURATION);
		errorCodeFilterList.add(UOSResultCode.NO_SUCH_WEBSITE_CONFIGURATION);
		errorCodeFilterList.add(UOSResultCode.NO_SUCH_LIFECYCLE);
	}
