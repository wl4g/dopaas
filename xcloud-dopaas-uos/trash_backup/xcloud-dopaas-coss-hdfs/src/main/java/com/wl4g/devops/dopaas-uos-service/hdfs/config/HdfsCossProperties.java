 ...
 */
package com.wl4g.devops.uos.hdfs.config;
...
public class HdfsCossProperties {
	 ...
	 */
	@NotNull
	private URI endpointHdfsRootUri = URI.create("hdfs://localhost:8020/uos-bucket");
	 ...
	 * <pre>
	 * e.g:
	 * getObjectKey("hdfs://localhost:8020/uos-bucket/bucket1/sample1/hdfs-uos-sample.txt") => sample1/hdfs-uos-sample.txt
	 * </pre>
	 * 
	 * @param bucketName
	 * @param filePath
