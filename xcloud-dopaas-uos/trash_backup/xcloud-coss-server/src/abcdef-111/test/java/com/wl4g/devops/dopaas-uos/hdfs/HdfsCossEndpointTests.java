...
public class HdfsCossEndpointTests {
	...
	public void hdfsEndpointPutObjectTest() throws Exception {
		...
		endpoint.putObject("sm-clound", "hdfs-uos-sample.txt", new FileInputStream(createSampleFile()));
	}
	...
	public void hdfsEndpointGetObjectTest() throws Exception {
		...
		ObjectValue object = endpoint.getObject("sm-clound", "hdfs-uos-sample.txt");
		System.out.println(object);
	}

	private File createSampleFile() throws IOException {
		File file = File.createTempFile("hdfs-uos-sample", ".txt");
		file.deleteOnExit();
