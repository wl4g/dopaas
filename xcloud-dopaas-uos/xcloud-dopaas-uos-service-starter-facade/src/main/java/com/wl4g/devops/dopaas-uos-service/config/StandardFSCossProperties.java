...
public abstract class StandardFSCossProperties {
	 ...
	 */
	@NotNull
	private File endpointRootDir = new File("/mnt/disk1/uos-bucket");
	 ...
	 * <pre>
	 * e.g:
	 * getObjectKey("/mnt/disk1/uos-bucket/bucket1/sample1/hdfs-uos-sample.txt") => sample1/hdfs-uos-sample.txt
	 * </pre>
	 * 
	 * @param bucketName
	 * @param filePath
	 ...
	 * <pre>
	 * e.g:
	 * getObjectKey("/mnt/disk1/uos-bucket/bucket1/") => bucket1
	 * </pre>
	 * 
	 * @param filePath
	 * @return
