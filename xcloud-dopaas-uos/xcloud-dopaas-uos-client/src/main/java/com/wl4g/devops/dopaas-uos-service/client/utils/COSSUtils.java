 ...
 */
package com.wl4g.devops.uos.client.utils;

import static com.wl4g.devops.uos.common.internal.define.UOSConstants.DEFAULT_CHARSET_NAME;
import static com.wl4g.devops.uos.common.internal.define.UOSConstants.OBJECT_NAME_MAX_LENGTH;
import static com.wl4g.devops.uos.common.internal.define.UOSConstants.RESOURCE_NAME_COMMON;
import static com.wl4g.devops.uos.common.internal.define.UOSConstants.RESOURCE_NAME_UOS;
...
import com.wl4g.devops.uos.common.exception.InconsistentException;
import com.wl4g.devops.uos.common.internal.ResponseHeaderOverrides;
import com.wl4g.devops.uos.common.internal.ResponseMessage;
import com.wl4g.devops.uos.common.model.ObjectMetadata;
import com.wl4g.devops.uos.common.utils.UOSHeaders;
import com.wl4g.devops.uos.common.utils.DateUtil;
import com.wl4g.devops.uos.common.utils.LocalizedManager;

public class UOSUtils {

	public static final LocalizedManager OSS_RESOURCE_MANAGER = LocalizedManager.getInstance(RESOURCE_NAME_UOS);
	...
	public static String makeResourcePath(String key) {
		return key != null ? UOSUtils.urlEncodeKey(key) : null;
	}
	...
	public static String makeResourcePath(String bucket, String key) {
		if (bucket != null) {
			return bucket + "/" + (key != null ? UOSUtils.urlEncodeKey(key) : "");
		} else {
			return null;
		}
	}
		...
		if (userMetadata != null) {
			for (Entry<String, String> entry : userMetadata.entrySet()) {
				if (entry.getKey() != null && entry.getValue() != null) {
					...
					if (value != null)
						value = value.trim();
					headers.put(UOSHeaders.OSS_USER_METADATA_PREFIX + key, value);
				}
			}
		}
	}
