...
public class UmcReceiveAutoConfiguration extends AbstractOptionalControllerConfiguration {
	...
	@EnableHttpReceiver
	public HttpCollectReceiver httpCollectReceiver(PhysicalMetricStore pStore, VirtualMetricStore vStore, RedisMetricStore rStore, ZookeeperMetricStore zStore, KafkaMetricStore kStore,StatInfoMetricStore mStore) {
		return new HttpCollectReceiver(pStore, vStore, rStore, zStore, kStore,mStore);
	}
	...
	@EnableKafkaReceiver
	public KafkaCollectReceiver kafkaCollectReceiver(PhysicalMetricStore pStore, VirtualMetricStore vStore, RedisMetricStore rStore, ZookeeperMetricStore zStore, KafkaMetricStore kStore,StatInfoMetricStore mStore) {
		return new KafkaCollectReceiver(pStore, vStore, rStore, zStore, kStore,mStore);
	}
