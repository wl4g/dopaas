...
type IOCountersStat struct {
	...
	Errin       uint64 `json:"errin"`       // physical number of errors while receiving
	Errout      uint64 `json:"errout"`      // physical number of errors while sending
	Dropin      uint64 `json:"dropin"`      // physical number of incoming packets which were dropped
	Dropout     uint64 `json:"dropout"`     // physical number of outgoing packets which were dropped (always 0 on OSX and BSD)
	Fifoin      uint64 `json:"fifoin"`      // physical number of FIFO buffers errors while receiving
	Fifoout     uint64 `json:"fifoout"`     // physical number of FIFO buffers errors while sending
