...
import com.wl4g.devops.common.bean.umc.dto.AlarmConfigRedis;
...
import static com.wl4g.devops.common.constants.UMCDevOpsConstants.REDIS_PRO_UMC_ALARM;
import static com.wl4g.devops.common.constants.UMCDevOpsConstants.REDIS_PRO_UMC_IP_TO_ID;
...
public class RuleManager {
    ...
    public void putAllAlarmConfigIntoRedis(){
        ...
        for (Map.Entry<Integer, Set<Integer>> entry : tagToTemplate.entrySet()) {
            ...
            AlarmConfigRedis alarmConfigRedis = new AlarmConfigRedis();
            alarmConfigRedis.setInstantId(instandId);
            ...
            jedisService.set(REDIS_PRO_UMC_ALARM+String.valueOf(instandId),json,0);
    ...
    public void putInstandIPToIdInRedis(){
        ...
        for(AppInstance appInstance1 : instancelist){
            jedisService.set(REDIS_PRO_UMC_IP_TO_ID+appInstance1.getIp()+":"+appInstance1.getPort(),String.valueOf(appInstance1.getId()),0);
        }
