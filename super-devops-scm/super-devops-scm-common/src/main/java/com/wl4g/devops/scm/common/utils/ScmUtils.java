...
public final class ScmUtils {
	 ...
	 * @return
	 */
	public final static String genZkConfigPath(GenericInfo base, ReleaseInstance instance) {
	...
	private final static void checkInvalid(GenericInfo base, ReleaseInstance instance) {
