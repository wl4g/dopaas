...
public class LocalCommand extends BasicCommand {
	...
	public LocalCommand(String command, File stdout, long timeoutMs) {
		this(null, command, null, stdout, timeoutMs);
	}

	public LocalCommand(String command, File stdout, long timeoutMs, Executor inputExecutor) {
		this(null, command, null, stdout, timeoutMs, inputExecutor);
	}

	public LocalCommand(String command, File pwdDir, File stdout, long timeoutMs) {
		this(null, command, pwdDir, stdout, timeoutMs);
	}

	public LocalCommand(String command, File pwdDir, File stdout, long timeoutMs, Executor inputExecutor) {
		this(null, command, pwdDir, stdout, timeoutMs, inputExecutor);
	}

	public LocalCommand(String processId, String command, long timeoutMs) {
		this(processId, command, null, null, timeoutMs);
	}

	public LocalCommand(String processId, String command, File pwdDir, File stdout, long timeoutMs) {
		this(processId, command, pwdDir, stdout, timeoutMs, null);
	}

	public LocalCommand(String processId, String command, File pwdDir, File stdout, long timeoutMs, Executor inputExecutor) {
