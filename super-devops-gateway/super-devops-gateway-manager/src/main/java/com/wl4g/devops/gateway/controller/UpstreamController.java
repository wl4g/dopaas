...
public class UpstreamController extends BaseController {
	...
	public RespBase<?> list(PageModel pm, String name) {
		...
		resp.setData(upstreamService.page(pm, name));
		return resp;
	}

	@RequestMapping(value = "/save")
	public RespBase<?> save(@RequestBody GWUpstream gwUpstream) {
		RespBase<Object> resp = RespBase.create();
		upstreamService.save(gwUpstream);
		return resp;
	}
	...
	public RespBase<?> detail(Integer id) {
		RespBase<Object> resp = RespBase.create();
		resp.setData(upstreamService.detail(id));
		return resp;
	}
	...
	public RespBase<?> getForSelect() {
		RespBase<Object> resp = RespBase.create();
		resp.setData(upstreamService.getForSelect());
		return resp;
	}
}