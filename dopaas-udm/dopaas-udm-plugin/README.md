...
<build>
    <plugins>
        ...
        <plugin>
            ...
            <artifactId>dopaas-doc-plugin-swagger</artifactId>
...
> Example codes reference to: [dopaas-doc-plugin-sample/pom.xml](dopaas-doc-plugin-sample/pom.xml)
