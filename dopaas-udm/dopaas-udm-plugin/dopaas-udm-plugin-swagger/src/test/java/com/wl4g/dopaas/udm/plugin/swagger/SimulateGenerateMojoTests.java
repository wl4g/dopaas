...
import com.wl4g.dopaas.udm.plugin.swagger.jaxrs2.GenerateJaxrs2Oas3Mojo;
import com.wl4g.dopaas.udm.plugin.swagger.springdoc.oas3.GenerateSpringdocOas3Mojo;
import com.wl4g.dopaas.udm.plugin.swagger.springfox.oas3.GenerateSpringfoxOas3Mojo;
import com.wl4g.dopaas.udm.plugin.swagger.springfox.swagger2.GenerateSpringfoxSwagger2Mojo;
...
public class SimulateGenerateMojoTests {
	...
	public void generateSpringfoxSwagger2MojoTest() throws Exception {
		createMavenMojoInstance(GenerateSpringfoxSwagger2Mojo.class,
				singleton("com.wl4g.dopaas.udm.plugin.swagger.example.swagger2"), "swagger-swagger2-by-springfox").execute();
	}

	@Test
	public void generateSpringfoxOas3MojoTest() throws Exception {
		createMavenMojoInstance(GenerateSpringfoxOas3Mojo.class, singleton("com.wl4g.dopaas.udm.plugin.swagger.example.oas3"),
				"swagger-oas3-by-springfox").execute();
	}

	// @Test
	public void generateSpringdocOas3MojoTest() throws Exception {
		createMavenMojoInstance(GenerateSpringdocOas3Mojo.class, singleton("com.wl4g.dopaas.udm.plugin.swagger.example.oas3"),
				"swagger-oas3-by-springdoc").execute();
	}

	// @Test
	public void generateJaxrs2Oas3MojoTest() throws Exception {
		createMavenMojoInstance(GenerateJaxrs2Oas3Mojo.class, singleton("com.wl4g.dopaas.udm.plugin.swagger.example.jaxrs2"),
