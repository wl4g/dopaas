...
import com.wl4g.dopaas.udm.plugin.swagger.config.oas3.Oas3Properties;
import com.wl4g.dopaas.udm.plugin.swagger.springfox.plugin.ApiVersionPathsRequestHandlerCombiner;
import com.wl4g.dopaas.udm.plugin.swagger.springfox.plugin.AuthorOperationBuilderPlugin;
import com.wl4g.dopaas.udm.plugin.swagger.springfox.plugin.OrderOperationBuilderPlugin;
import com.wl4g.dopaas.udm.plugin.swagger.springfox.plugin.VersionedApiListingPlugin;
import com.wl4g.dopaas.udm.plugin.swagger.config.oas3.Oas3Contact;
import com.wl4g.dopaas.udm.plugin.swagger.config.oas3.Oas3Info;
