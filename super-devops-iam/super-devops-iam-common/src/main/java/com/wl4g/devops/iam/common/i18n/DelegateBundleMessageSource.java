 ...
 * @since
 */
public class DelegateBundleMessageSource extends ResourceBundleMessageSource {
	...
	public DelegateBundleMessageSource() {
		this(DelegateBundleMessageSource.class);
	}

	public DelegateBundleMessageSource(Class<?> withClassPath) {
		this(getBasename(withClassPath));
	}

	public DelegateBundleMessageSource(String... basenames) {
	...
	public String getMessage(String code, Object... args) {
		return getSource().getMessage(code, args, (Locale) SessionBindings.getBindValue(KEY_USE_LOCALE));
	}
