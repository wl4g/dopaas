...
/**
 * Constructs queries for listing the events in a calendar, following the
 * builder pattern. The {@link #getPage()} method returns an {@link EventPage}
 * containing {@link Event} instances.
 * <p>
 * See <a href=
 * "http://developers.google.com/google-apps/calendar/v3/reference/events/list">
...
public interface EventListQueryBuilder extends ApiQueryBuilder<EventListQueryBuilder, EventPage> {
	/**
	 * Specifies whether to always include a value in the email field for the
	 ...
	 * Optional. The default is {@code false}.
	 * 
	 * @param alwaysIncludeEmail
	 *            whether to always include email.
	 ...
	 * 
	 * @param maxAttendees
	 *            the maximum number of attendees to include.
	 * @return this {@code EventListQueryBuilder}, for refining the query.
	 */
	 ...
	 * recurring event) will still be included if {@link #showDeleted} and
	 * {@link #singleEvents} are both {@code false}. If {@link #showDeleted} and
	 * {@link #singleEvents} are both {@code true}, only single instances of
	 * deleted events (but not the underlying recurring events) are returned.
	 * Optional. The default is {@code false}.
	 * 
	 * @param showDeleted
	 ...
	 * recurring events themselves. Optional. The default is {@code false}.
	 * 
	 * @param singleEvents
	 *            whether to expand recurring events into single events.
	 * @return this {@code EventListQueryBuilder}, for refining the query.
	 */
	...
	/**
	 * Lower bound for an event's last modification time to filter by. When
	 * specified, entries deleted since this time will always be included
	 * regardless of showDeleted. Optional. The default is not to filter by last
	 * modification time.
	 * 
	 * @param updatedMin
	 *            the lower bound for an event's last modification time.
	 * @return this {@code EventListQueryBuilder}, for refining the query.
	 */
