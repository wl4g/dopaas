...
@JsonSubTypes({ @Type(AddActivity.class), @Type(BuyActivity.class), @Type(CheckInActivity.class), @Type(CommentActivity.class),
		@Type(CreateActivity.class), @Type(DiscoverActivity.class), @Type(ListenActivity.class), @Type(ReserveActivity.class),
...
public abstract class Moment extends ApiEntity {
	...
	public Moment(final String targetUrl) {
