...
public class UploadParameters {
	...
	/**
	 * Returns a string representation of the true and non-null parameters to be
	 ...
	 *            Target language to translate the file to. If no sourceLanguage
	 *            is provided, the API will attempt to detect the language.
	 * @return the {@link UploadParameters} instance
	 */
