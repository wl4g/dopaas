...
/**
 * A builder of a map to be used as the request body of PATCH operations. The
 * following code:
 * 
 * <pre>
 * new PatchBuilder().set("labels.starred", true).set("labels.hidden", false).getMap();
 * </pre>
 * 
...
public class PatchBuilder {
	 ...
	 * 
	 * @param path
	 *            the path representing the property, with "." representing
	 *            nested properties
	 * @param value
	...
	/**
	 * Defines a property to be deleted by setting its value to null. Equivalent
	 * to invoking {@link PatchBuilder#set(String, Object)} with null value
	 * 
	 * @param path
	 *            the path representing the property, with "." representing
	 *            nested properties
