...
/**
 * Interface for constructing queries for updating a existing event in a
 * calendar, following the builder pattern.
 * <p>
 * (Currently only used internally within
 * {@link CalendarOperations#updateEvent}.)
 * </p>
 *
 * @author Martin Wink
 */
