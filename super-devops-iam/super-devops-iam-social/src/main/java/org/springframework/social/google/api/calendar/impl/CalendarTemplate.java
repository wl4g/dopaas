...
public class CalendarTemplate extends AbstractGoogleApiOperations implements CalendarOperations {
	...
	public EventListQueryBuilder eventListQuery(final String calendarId) {
		...
		return new EventListQueryBuilderImpl(CALENDAR_BASE_URL + "/calendars/{0}/events", calendarId, EventPage.class,
				restTemplate);
	}
	...
	public Calendar getCalendar(final String calendarId) {
		Assert.notNull(calendarId, "CalendarId must not be null");
		final CalendarGetQueryBuilderImpl builder = new CalendarGetQueryBuilderImpl(
				CALENDAR_BASE_URL + "/users/me/calendarList/{0}", calendarId);
	...
	public Event getEvent(final String calendarId, final String eventId) {
		...
		final EventGetQueryBuilderImpl builder = new EventGetQueryBuilderImpl(CALENDAR_BASE_URL + "/calendars/{0}/events/{1}",
				calendarId, eventId);
	...
	public Event quickAddEvent(final String calendarId, final String specification, final boolean sendNotifications) {
		...
		final QuickAddEventBuilder builder = new QuickAddEventBuilderImpl(CALENDAR_BASE_URL + "/calendars/{0}/events/quickAdd",
				calendarId);
	...
	public void deleteEvent(final String calendarId, final String eventId, final boolean sendNotifications) {
		Assert.notNull(calendarId, "CalendarId must not be null");
		Assert.notNull(eventId, "EventId must not be null");
		final DeleteEventBuilder builder = new DeleteEventBuilderImpl(CALENDAR_BASE_URL + "/calendars/{0}/events/{1}", calendarId,
				eventId);
	...
	public void updateEvent(final String calendarId, final Event event, final boolean sendNotifications) {
		...
		final UpdateEventBuilderImpl builder = new UpdateEventBuilderImpl(CALENDAR_BASE_URL + "/calendars/{0}/events/{1}",
