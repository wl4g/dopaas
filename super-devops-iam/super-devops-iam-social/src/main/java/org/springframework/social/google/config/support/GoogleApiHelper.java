...
public class GoogleApiHelper implements ApiHelper<Google> {
	...
	private GoogleApiHelper(final UsersConnectionRepository usersConnectionRepository, final UserIdSource userIdSource) {
	...
	public Google getApi() {
		...
		final Connection<Google> connection = usersConnectionRepository.createConnectionRepository(userIdSource.getUserId())
