 ...
 *
 * @see <a href=
 *      "https://developers.google.com/+/api/moment-types/comment-activity">Comment
 *      Activity</a>
 * @author Gabriel Axel
 *
 */
...
public class CommentActivity extends Moment {
	...
	public CommentActivity(final String targetUrl, final String resultUrl, final String resultText, final String resultName) {
