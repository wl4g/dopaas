 ...
 * <p>
 * See the reference documentation at <a href=
...
public class Event extends ApiEntity {
	 ...
	 * itself. Only some of the possible modifications are currently
	 * implemented.
	 */
	protected Event() {
		super();
	 ...
	 *
	 * @param status
	 *            the new status, or {@code null} for none.
	 ...
	 *
	 * @param location
	 *            the new location, or {@code null} for none.
	 * @return this event, to allow chaining.
	 */
	...
	/**
	 * The organizer of this event. If the organizer is also an attendee, this
	...
	/**
	 * The (inclusive) start time of this event. For a recurring event, this is
	...
	/**
	 * The (exclusive) end time of this event. For a recurring event, this is
	 ...
	 * {@code true}. If {@code true}, the end time should be disregarded.
	 *
	 * @return the value or {@code null} if none.
	 */
	...
	/**
	 * For an instance of a recurring event, return this event ID of the
	 ...
	 * identified by {@link #recurringEventId}.
	 *
	 * @return the value or {@code null} if none.
	 */
	 ...
	 * the maxAttendee query parameter.
	 *
	 * @return the value or {@code null} if none.
	 */
	...
	/**
	 * Whether attendees other than the organizer can invite others to this
	 * event.
	 *
	 * @return the value or {@code null} if none.
	 */
	 ...
	 * This field is omitted for single events or <em>instances</em> of
	 * recurring events.
	 *
	 * @return the value or {@code null} if none.
	 */
	...
	/**
	 * Replaces the list of RRULE, EXRULE, RDATE and EXDATE lines for a
	 * recurring event.
	 *
	 * @param list
	 *            the new list, or {@code null} for none.
	 * @return this event, to allow chaining.
	 */
	 ...
	 * web page, an email message or any document identifiable by an URL using
	 * HTTP/HTTPS protocol. Accessible only by the creator of this event.
	 *
	 * @return the value or {@code null} if none.
	 */
	...
	/**
	 * Sets whether attendees other than the organizer can invite others to the
	 * event.
	 *
	...
	/**
	 * Sets whether attendees other than the organizer can see who the event's
	 * attendees are.
	 *
	 ...
	 * <p>
	 * Only a {@link #date} or a {@link #dateTime} may be specified.
	 * </p>
	 */
	public static class DateTimeTimezone {
		...
		/**
		 * The date, if this is an all-day event. The time should be midnight on
		 * the given date.
		 *
		 * @return the value or {@code null} if none.
		 */
		...
		/**
		 * Set the date to make this an all-day event. For consistency, if a non
		 * {@code null} value is set, making this an all-day event, the time
		 * property must be set to {@code null}.
		 *
		 * @param date
		 *            the new value or {@code null} if none.
		...
		/**
		 * Set the time, to make this not an all-day event. For consistency, if
		 * a non {@code null} value is set, this cannot also be an all-day
		 * event, so the date property must be set to {@code null}.
		 *
		 * @param dateTime
		 *            the new value or {@code null} if none.
		 * @return this {@link DateTimeTimezone}, for chaining.
		 ...
		 * "Europe/Zurich"). The time zone is required for recurring events.
		 *
		 * @param timeZone
		 *            the new value or {@code null} if none.
		 * @return this {@link DateTimeTimezone}, for chaining.
	...
	public static class ReminderOverride {
		...
		/**
		 * The number of minutes before the start of the event when this
	...
	public static class Reminders {
		...
		/**
		 * If the event doesn't use the default reminders, this returns the list
		 * of reminders specific to the event, or, if not set, indicates that no
	...
	public static class Source {
		...
		/**
		 * The URL of the source pointing to a resource. The URL's protocol will
		 * be HTTP or HTTPS.
		 *
		 * @return the value or {@code null} if none.
		 */
		...
		/**
		 * The title of the source; for example a title of a web page or an
		 * email subject.
		 *
		 * @return the value or {@code null} if none.
		 */
