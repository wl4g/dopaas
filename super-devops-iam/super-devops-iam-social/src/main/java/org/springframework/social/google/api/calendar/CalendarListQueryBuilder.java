...
/**
 * Constructs queries for listing the accessible calendars, following the
 * builder pattern. The {@link #getPage()} method returns a {@link CalendarPage}
 * containing {@link Calendar} instances.
 * <p>
 * See the reference documentation at <a href=
 * "http://developers.google.com/google-apps/calendar/v3/reference/calendarList/list">
...
public interface CalendarListQueryBuilder extends ApiQueryBuilder<CalendarListQueryBuilder, CalendarPage> {
	 ...
	 * 
	 * @param showDeleted
	 *            whether to include deleted calendar list entries in the
	 *            result.
	 * @return this {@code CalendarListQueryBuilder}, for refining the query.
	 */
