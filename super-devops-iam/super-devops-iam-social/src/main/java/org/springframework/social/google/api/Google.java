...
public interface Google extends ApiBinding {
	...
	/**
	 * Retrieves {@link OAuth2Operations}, used for interacting with Google+
	 * API.
	 *
	 ...
	 * </ul>
	 * See
	 * <a href="https://developers.google.com/drive/scopes">https://developers
	...
	/**
	 * Retrieves {@link CalendarOperations}, used for interacting with Google
	 * Calendar API. Some methods require OAuth2 scope from the following:
	 * <ul>
	 * <li>https://www.googleapis.com/auth/calendar.readonly</li>
	 * <li>https://www.googleapis.com/auth/calendar</li>
	 * </ul>
	 *
	 * @return {@link CalendarOperations} for the authenticated user if
	 *         authenticated
	 */
	CalendarOperations calendarOperations();

	/**
	 * Retrieves {@link PeopleOperations}, used for interacting with Google
	 * People API. Some methods require OAuth2 scope
	 * https://people.googleapis.com/v1/me
	 *
	 * @return {@link PeopleOperations} for the authenticated user if
	 *         authenticated
	 */
