 ...
 *
 * @see <a href=
 *      "https://developers.google.com/+/api/moment-types/review-activity">Review
 *      Activity</a>
 * @author Gabriel Axel
 *
 */
...
public class ReviewActivity extends Moment {
	...
	public ReviewActivity(final String targetUrl, final String url, final String text, final String name,
