 ...
 * http://developers.google.com/google-apps/calendar/v3/reference/</a>. <br>
 ...
 * </ul>
 * See <a href=
 * "http://developers.google.com/google-apps/calendar/auth">http://developers.google.com/google-apps/calendar/auth</a>
...
public interface CalendarOperations {
	...
	/**
	 * Create a builder pattern object for refining a query that lists the
	 * calendars that are accessible to the authenticated user.
	 * 
	 ...
	 * 
	 * @param calendarId
	 *            the calendar's identifier. The special identifier "primary"
	...
	/**
	 * Create a builder pattern object for refining a query that lists the
	 * events that are accessible to the authenticated user.
	 * 
	 * @param calendarId
	 *            the calendar's identifier. The special identifier "primary"
	 *            ({@link #PRIMARY_CALENDAR_ID}) may be used.
	...
	/**
	 * Create a new event in the specified calendar, based on the specification
	 * text.
	 * 
	 * @param calendarId
	 *            the calendar's identifier. The special identifier "primary"
	 ...
	 * 
	 * @param calendarId
	 *            the identifier of the calendar containing the event. The
	 *            special identifier "primary" ({@link #PRIMARY_CALENDAR_ID})
	 *            may be used.
	 * @param eventId
	 *            the event's identifier.
	 * @param sendNotifications
	 ...
	 *            The event to update.
	 * @param sendNotifications
	 *            Whether to send notifications about the update to the event.
	 */
