...
public class Calendar extends ApiEntity {
	...
	/**
	 * Constructor protected so instances must be retrieved from Google
	 * Calendar.
	 */
	protected Calendar() {
		super();
	...
	/**
	 * The overriding summary that the authenticated user has set for this
	 * calendar.
	 * 
	 * @return the value or {@code null} if none.
	 */
	...
	/**
	 * The effective access role that the authenticated user has on this
	 * calendar.
	 * 
	 * @return the value or {@code null} if none.
	 */
	...
	public static class EventReminder {
		...
		/**
		 * The number of minutes before the start of the event when the reminder
		 * should trigger.
		 * 
		 * @return the value.
		 */
