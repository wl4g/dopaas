...
public class Organization {
	...
	Organization(final String name, final String title, final String type, final String startDate, final String endDate,
	...
	public boolean equals(final Object o) {
		...
		return nullSafeEquals(name, other.name) && nullSafeEquals(title, other.title) && nullSafeEquals(type, other.type)
				&& nullSafeEquals(startDate, other.startDate) && nullSafeEquals(endDate, other.endDate)
