...
public abstract class AbstractSnsHandler implements SnsHandler {
     ...
     *
     * @param provider   SNS connect provider name
     * @param callbackId Oauth2 callback process id
     * @param request
     * @return
     */
     ...
     * URL)
     *
     * @param refreshUrl    Default: Refresh redirection URL, or other message
     * @param connectParams SNS connect parameters
     * @return
     */
