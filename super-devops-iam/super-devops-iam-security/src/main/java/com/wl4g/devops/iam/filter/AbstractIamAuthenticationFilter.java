...
public abstract class AbstractIamAuthenticationFilter<T extends IamAuthenticationToken> extends AuthenticatingFilter
     ...
     *
     * @param request
     * @param bindOnly Whether to get only the redirection information of the binding
     * @return
     */
     ...
     * @param fromAppName from application name
     * @param grantTicket logged information model
     * @param successUrl  login success redirect URL
     * @return
     */
    @SuppressWarnings({"rawtypes", "unchecked"})
     ...
     *
     * @param failRedirectUrl failure redirect URL
     * @param request         Servlet request
     * @param params          Redirected query configuration parameters
     * @param thw             Exception object
     * @return
     */
    @SuppressWarnings({"rawtypes", "unchecked"})
