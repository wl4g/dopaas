...
@Documented
@Import({ BasedConfigAutoConfiguration.class, IamAutoConfiguration.class, LoginAutoConfiguration.class, SnsAutoConfiguration.class,
		DefaultViewAutoConfiguration.class })
