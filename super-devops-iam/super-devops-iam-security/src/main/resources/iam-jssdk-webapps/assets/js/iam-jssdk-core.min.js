...
r=Common.Util.getCookie(l,null);h.debug("Loaded cache xsrfTokenValue:",r,"by cookieName:",l);var k=!a;r||(h.debug("Loading new xsrf token..."),f=IAMCore.getIamBaseUri()+Common.Util.checkEmpty("definition.applyXsrfTokenUrlKey",c.definition.applyXsrfTokenUrlKey),Common.Util.Http.request({url:f,type:"HEAD",async:!k,xhrFields:{withCredentials:!0},success:function(c,f,e){r=Common.Util.getCookie(l);h.info("Loaded new xsrfTokenValue:",r,"by cookieName:",l);k||a(g(b,d,r))},error:function(a,b,c){h.error("Failed to init xsrf token. "+
