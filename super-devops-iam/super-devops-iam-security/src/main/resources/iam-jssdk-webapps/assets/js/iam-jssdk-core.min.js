...
a.code+""==c.definition.code401Value)||b}return!1},v=function(a){var b=Common.Util.checkEmpty("definition.xsrfTokenHeaderKey",c.definition.xsrfTokenHeaderKey),d=Common.Util.checkEmpty("definition.xsrfTokenParamKey",c.definition.xsrfTokenParamKey),g=function(a,b,c){a={headerName:a,paramName:b,value:c};h.debug("Got xsrfToken:",a);return a},f=location.hostname,e=Common.Util.extTopDomainString(f),l=f,e=f.indexOf(e);0<e&&(l=f.substring(0,e-1));var l=l.replace(".","_").toUpperCase(),m="IAM-"+l+"-XSRF-TOKEN",
t=Common.Util.getCookie(m,null);h.debug("Loaded cache xsrfTokenValue:",t,"by cookieName:",m);var k=!a;t||(h.debug("Loading new xsrf token..."),f=IAMCore.getIamBaseUri()+Common.Util.checkEmpty("definition.applyXsrfTokenUrlKey",c.definition.applyXsrfTokenUrlKey),Common.Util.Http.request({url:f,type:"HEAD",async:!k,xhrFields:{withCredentials:!0},success:function(c,f,e){t=Common.Util.getCookie(m);h.info("Loaded new xsrfTokenValue:",t,"by cookieName:",m);k||a(g(b,d,t))},error:function(a,b,c){h.error("Failed to init xsrf token. "+
c)}}));if(k)return g(b,d,Common.Util.getCookie(m))},w=function(){for(var a=(new Date).getTime(),b="",d=0;2>d;d++)b+=Math.random().toString(36).substr(2);for(var d=Common.Util.sortWithAscii(b+a),g=Common.Util.Crc16CheckSum.crc16Modbus(d),g=parseInt(g%d.length/Math.PI)+1,f=d,d=0;d<g;d++)f=CryptoJS.MD5(f).toString(CryptoJS.enc.Hex);d=JSON.stringify({n:b,t:a,s:f});a=Common.Util.checkEmpty("definition.replayTokenHeaderKey",c.definition.replayTokenHeaderKey);b=Common.Util.checkEmpty("definition.replayTokenParamKey",
c.definition.replayTokenParamKey);g=Common.Util.Codec.encodeBase58(d);h.debug("Generated replay token(plain): ",d," - ",g);return{headerName:a,paramName:b,value:g}},D=function(){var a=location.protocol,b=location.hostname,d=c.deploy.defaultServerPort,g=c.deploy.defaultTwoDomain,f=c.deploy.defaultContextPath,f=f.startsWith("/")?f:"/"+f;if(Common.Util.isIp(b)||"localhost"==b||"127.0.0.1"==b||b.endsWith(".debug")||b.endsWith(".local")||b.endsWith(".dev"))return a+"//"+b+":"+d+f;b=Common.Util.extTopDomainString(b);
return a+"//"+g+"."+b+f},B=function(){var a=new Map,b=encodeURIComponent(Common.Util.getEleValue("account.principalInput",c.account.principalInput));a.set(Common.Util.checkEmpty("definition.principalKey",c.definition.principalKey),b);a.set(Common.Util.checkEmpty("definition.umidTokenKey",c.definition.umidTokenKey),e.umid.getValue());a.set(Common.Util.checkEmpty("definition.verifyTypeKey",c.definition.verifyTypeKey),Common.Util.checkEmpty("captcha.use",c.captcha.use));a.set(Common.Util.checkEmpty("definition.responseType",
