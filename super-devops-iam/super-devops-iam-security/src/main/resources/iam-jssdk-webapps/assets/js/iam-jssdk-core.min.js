...
IAMCore.prototype.getXsrfToken=u;IAMCore.prototype.generateReplayToken=v;IAMCore.prototype.checkAuthenticationAndRedirect=function(a){return new Promise(function(b,d){z().then(function(c){if(!IAMCore.checkRespUnauthenticated(c)){sessionStorage.setItem(h.authenticatedRedirectCountStorageKey,0);c=parseInt(sessionStorage.getItem(h.authenticatedRedirectCountStorageKey)||0);if(10<c)throw Error("Too many failure redirects: "+c);sessionStorage.setItem(h.authenticatedRedirectCountStorageKey,++c);IAMCore.Console.info("Login authenticated, redirect to: "+
a);p.location=a}b()})})};IAMCore.Console={_isVerbose:function(){var a=sessionStorage.getItem(h.iamVerboseStoredKey);return a?(a=a.toUpperCase(),"TRUE"==a||"1"==a||"Y"==a||"YES"==a):!1},debug:function(a){IAMCore.Console._isVerbose()&&console.debug(a)},info:function(a){IAMCore.Console._isVerbose()&&console.info(a)},warn:function(a){IAMCore.Console._isVerbose()&&console.warn(a)},error:function(a){IAMCore.Console._isVerbose()&&console.error(a)}};IAMCore.checkRespUnauthenticated=t;IAMCore.checkRespSuccess=
function(a){return a.code==b.definition.code401Value||a.code+""==b.definition.code401Value?!0:!1};IAMCore.multiModularMutexAuthenticatingHandler=y.doHandle;IAMCore.getIamBaseUri=function(){var a=sessionStorage.getItem(h.baseUriStoredKey);a||sessionStorage.setItem(h.baseUriStoredKey,a=C());return a}})(window,document);