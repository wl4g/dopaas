...
b){throw"Unsupported errors, please implement to support get which function";},refreshUrl:null},getPrincipal:function(){},qrcodePanel:null,pagePanel:null,provider:null,onBefore:function(a,b,d){}}},h={_isVerbose:function(){var a=sessionStorage.getItem(k.iamVerboseStoredKey);return a?(a=a.toUpperCase(),"TRUE"==a||"1"==a||"Y"==a||"YES"==a):!1},_doLog:function(a,b){if(h._isVerbose()){var d=(new Date).format("[yyyy-MM-dd hh:mm:ss.S]")+" "+a+" --- ",c=[];c.push(d);for(var f in b)c.push(b[f]);switch(a){case "TRACE":console.trace.apply(console,
c);break;case "DEBUG":console.debug.apply(console,c);break;case "INFO":console.info.apply(console,c);break;case "WARN":console.warn.apply(console,c);break;case "ERROR":console.error.apply(console,c);break;default:console.log.apply(console,c)}}},trace:function(){h._doLog("TRACE",arguments)},debug:function(){h._doLog("DEBUG",arguments)},info:function(){h._doLog("INFO",arguments)},warn:function(){h._doLog("WARN",arguments)},error:function(){h._doLog("ERROR",arguments)},log:function(){h._doLog("INFO",
...
$.ajax({url:m,type:a,async:b||!0,headers:JSON.fromMap(d),data:g,xhrFields:{withCredentials:!0},success:function(a,b,d){f&&f(a)},error:function(a,b,d){h&&h(d)},complete:function(a){l&&l(a)}})},z={mutexControllerManager:new Map,doMultiModularRequest:function(a,b,d,c,e,h,l){n(a,d,"@"+b,c||{},e,h,l,!1)},checkTGCExpiredAndRedirectToLogin:function(a,b){h.debug("TGC validating... res: ",a);return u(a)&&a.data&&"IamWithCasAppServer"==a.data.serviceRole?(h.info("TGC expired, redirectTo: ",a.data[c.definition.redirectUrlKey]),
b(a),!0):!1},getMutexController:function(a){var b=z,d=null;a.toUpperCase().startsWith("HTTP://")?(a=new URL(a),d=a.protocol+"://"+a.host):d=location.origin+"//"+a;var c=b.mutexControllerManager.get(d);c||b.mutexControllerManager.set(d,c={_cache_auth_state:{state:!1,time:0},urlSame:d,currentlyInAuthenticatingState:!1,requestQueue:[],authenticated:function(a){var b=c._cache_auth_state;if(a)b.state=a,b.time=(new Date).getTime();else return b.state&&1E4>Math.abs((new Date).getTime()-b.time)}});return c},
doHandle:function(a,b,c,e,f,k,l){var d=z;Common.Util.checkEmpty("multiModularAuthenticatingRequest.res",a);Common.Util.checkEmpty("multiModularAuthenticatingRequest.method",b);Common.Util.checkEmpty("multiModularAuthenticatingRequest.url",c);Common.Util.checkEmpty("multiModularAuthenticatingRequest.redirectFn",l);if(u(a)){var g=d.getMutexController(c);if(g.currentlyInAuthenticatingState){var n={res:a,method:b,url:c,successFn:e,errorFn:f,params:k};g.requestQueue.push(n);h.info("Offered authenticating authRequest: ",
n,", requestQueue: ",g.requestQueue)}else g.currentlyInAuthenticatingState=!0,(new Promise(function(c,e){h.info("Biz unauth response: ",a);g.authenticated()?c():d.checkTGCExpiredAndRedirectToLogin(a,l)||(a.data&&a.data.redirect_url?d.doMultiModularRequest(b,a.data.redirect_url,!0,null,c,f,null):f(a))})).then(function(a){h.info("Iam-server response: ",a);if(!g.authenticated()&&!d.checkTGCExpiredAndRedirectToLogin(a,l)){if(a.data&&a.data.redirect_url)return new Promise(function(b,c){d.doMultiModularRequest("get",
...
a.url,a.successFn,a.errorFn,a.params,l)}})})}else h.debug("Ignore authenticated of url: ",c,", res: ",a)}},A=function(a){return e.umid.getValuePromise().then(function(b){return e.handshake.getValuePromise(b,a)})};p.IAMCore=function(a){e.__that=this;c=$.extend(!0,c,a);h.debug("Merged iam core settings: ",c);c.deploy.baseUri=D();h.info("Use overlay iam baseUri: ",c.deploy.baseUri);sessionStorage.setItem(k.baseUriStoredKey,c.deploy.baseUri)};IAMCore.prototype.getUMToken=function(){return runtim.umid.getValue()};
