...
(function(window, document) {
	...
	var _checkAuthenticationAndRedirect = function(redirectUrl) {
		...
		var _body = $("body");
		_body.append($('<div style="background:url('+constant.imageData.loading+');position:absolute;width:30px;height:30px;left:48%;top:50%;" id="iam_check_authc_redirect_shade"></div>'));
