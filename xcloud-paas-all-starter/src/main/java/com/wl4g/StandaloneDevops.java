 ...
 * "com.wl4g.paas.uci.web", "com.wl4g.paas.udc.web",
 * "com.wl4g.paas.udc.codegen.web", "com.wl4g.paas.udm.web",
 * "com.wl4g.paas.cmdb.web", "com.wl4g.paas.urm.web",
 * "com.wl4g.paas.umc.web" )
 * 
...
@EnableSmartRequestMapping({ "com.wl4g.iam.web", "com.wl4g.paas.**.web" })
@EnableIamClient
@EnableShellServer
@EnableComponentDBConfiguration({ "com.wl4g.paas.*.data", "com.wl4g.iam.data" })
