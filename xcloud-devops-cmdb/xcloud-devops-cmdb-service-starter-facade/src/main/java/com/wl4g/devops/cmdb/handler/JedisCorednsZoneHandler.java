 ...
 */
package com.wl4g.devops.cmdb.handler;
...
import com.wl4g.devops.cmdb.config.DnsProperties;
import com.wl4g.devops.cmdb.handler.standard.DNSResolveType;
...
public class JedisCorednsZoneHandler implements DnsZoneHandler {
	...
	private Map buildMap(DnsPrivateResolution privateResolute) {
		...
		switch (DNSResolveType.of(resolveType)) {
		case A:
