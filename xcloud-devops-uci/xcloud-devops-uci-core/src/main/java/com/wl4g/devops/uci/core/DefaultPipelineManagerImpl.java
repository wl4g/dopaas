 ...
 */
package com.wl4g.devops.uci.core;
...
import static com.wl4g.devops.uci.core.orchestration.DefaultOrchestrationManagerImpl.FlowStatus.FAILED;
import static com.wl4g.devops.uci.core.orchestration.DefaultOrchestrationManagerImpl.FlowStatus.RUNNING;
import static com.wl4g.devops.uci.core.orchestration.DefaultOrchestrationManagerImpl.FlowStatus.SUCCESS;
...
import com.wl4g.devops.uci.core.context.DefaultPipelineContext;
import com.wl4g.devops.uci.core.context.PipelineContext;
import com.wl4g.devops.uci.core.orchestration.OrchestrationManager;
import com.wl4g.devops.uci.data.PipeStageNotificationDao;
import com.wl4g.devops.uci.pipeline.provider.PipelineProvider;
import com.wl4g.devops.uci.service.PipelineHistoryService;
import com.wl4g.devops.uci.service.PipelineService;
import com.wl4g.devops.uci.service.ProjectService;
import com.wl4g.devops.uci.utils.HookCommandHolder.BuildCommand;
import com.wl4g.devops.uci.utils.HookCommandHolder.DeployCommand;
import com.wl4g.devops.uci.utils.HookCommandHolder.HookCommand;
import com.wl4g.devops.common.bean.uci.ClusterExtension;
import com.wl4g.devops.common.bean.uci.PipeStageBuilding;
import com.wl4g.devops.common.bean.uci.PipeStageBuildingProject;
...
import com.wl4g.devops.common.bean.uci.param.HookParameter;
import com.wl4g.devops.common.bean.uci.param.RollbackParameter;
...
import com.wl4g.devops.cmdb.service.AppClusterService;
