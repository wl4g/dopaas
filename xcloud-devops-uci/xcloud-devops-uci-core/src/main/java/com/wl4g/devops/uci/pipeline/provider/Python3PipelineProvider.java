...
import com.wl4g.devops.uci.pipeline.deploy.Python3PipeDeployer;
...
public class Python3PipelineProvider extends RestorableDeployPipelineProvider {
	...
	@Override
	protected void doBuildWithDefaultCommand(String projectDir, File logPath, Long taskId) throws Exception {
