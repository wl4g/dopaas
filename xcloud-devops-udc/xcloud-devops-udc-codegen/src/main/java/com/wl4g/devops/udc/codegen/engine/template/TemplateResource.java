 ...
 */
package com.wl4g.devops.udc.codegen.engine.template;
...
import static com.wl4g.devops.udc.codegen.engine.generator.render.ModelAttributeConstants.GEN_MODULE_NAME;
import static com.wl4g.devops.udc.codegen.engine.generator.render.ModelAttributeConstants.GEN_TABLE_ENTITY_NAME;
...
public final class TemplateResource implements Serializable {
	...
	public TemplateResource(@NotBlank String rawFilename, @Nullable byte[] content) {
		...
		/**
		 * {@link com.wl4g.devops.udc.codegen.bean.GenTable#moduleName}
		 */
		this.isForeachModules = contains(rawFilename, GEN_MODULE_NAME); // Modules
		/**
		 * {@link com.wl4g.devops.udc.codegen.bean.GenTable#entityName}
		 */
