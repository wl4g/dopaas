 ...
 */
package com.wl4g.devops.udc.codegen.service.impl;
...
import com.wl4g.devops.udc.codegen.bean.GenTable;
import com.wl4g.devops.udc.codegen.bean.GenTableColumn;
import com.wl4g.devops.udc.codegen.bean.extra.TableExtraOptionDefinition.GenTableExtraOption;
import com.wl4g.devops.udc.codegen.dao.GenTableColumnDao;
import com.wl4g.devops.udc.codegen.dao.GenTableDao;
import com.wl4g.devops.udc.codegen.engine.GenProviderSetDefinition;
import com.wl4g.devops.udc.codegen.engine.GenerateEngine;
import com.wl4g.devops.udc.codegen.engine.context.GeneratedResult;
import com.wl4g.devops.udc.codegen.engine.context.GenericParameter;
import com.wl4g.devops.udc.codegen.engine.converter.DbTypeConverter;
import com.wl4g.devops.udc.codegen.engine.converter.DbTypeConverter.DbType;
import com.wl4g.devops.udc.codegen.engine.converter.DbTypeConverter.TypeMappingWrapper.MappedMatcher;
import com.wl4g.devops.udc.codegen.engine.resolver.MetadataResolver;
import com.wl4g.devops.udc.codegen.engine.resolver.TableMetadata;
import com.wl4g.devops.udc.codegen.engine.resolver.TableMetadata.ColumnMetadata;
import com.wl4g.devops.udc.codegen.engine.specs.BaseSpecs.*;
import com.wl4g.devops.udc.codegen.engine.specs.JavaSpecs;
import com.wl4g.devops.udc.codegen.i18n.CodegenResourceMessageBundler;
import com.wl4g.devops.udc.codegen.service.GenDataSourceService;
import com.wl4g.devops.udc.codegen.service.GenProjectService;
import com.wl4g.devops.udc.codegen.service.GenerateService;
import com.wl4g.devops.udc.codegen.utils.BuiltinColumnDefinition;
...
import static com.wl4g.devops.udc.codegen.config.CodegenAutoConfiguration.BEAN_CODEGEN_MSG_SOURCE;
import static com.wl4g.devops.udc.codegen.engine.GenProviderSetDefinition.getProviders;
import static com.wl4g.devops.udc.codegen.engine.converter.DbTypeConverter.TypeMappingWrapper;
import static com.wl4g.devops.udc.codegen.engine.generator.GeneratorProvider.GenProviderAlias.IAM_SPINGCLOUD_MVN;
import static com.wl4g.devops.udc.codegen.engine.specs.BaseSpecs.*;
import static com.wl4g.devops.udc.codegen.engine.specs.JavaSpecs.underlineToHump;
