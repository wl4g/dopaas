...
public class ResultFormatter {
	...
	public final static String getUsageFormat(String argname, Options options) {
		...
		String hit = (options != null && options.getOptions() != null && !options.getOptions().isEmpty()) ? "[OPTIONS]"
				: "[NO OPTIONS] ...";
		fmt.printHelp(pw, fmt.getWidth(), String.format("%s %s", argname, hit), null, options, fmt.getLeftPadding(),
				fmt.getDescPadding(), null, true);
		pw.flush();
