...
//
// /** Shell context cache. */
// final private static ThreadLocal<ShellContext> contextCache = new
...
// throw new IllegalStateException("The context object was not retrieved. first
/// use bind()");
// }
// return context;
// }
...
/// {
// return currentShell(true).printf(new ProgressMessage(title, DEFAULT_WHOLE,
/// (int) (DEFAULT_WHOLE * progressPercent)));
// }
//
// /**
// * Print progress message to client console.
...
// * @return
// */
// public static ShellContext currentPrintf(String title, int whole, int
/// progress) {
// return currentShell(true).printf(new ProgressMessage(title, whole,
/// progress));
// }
//
// /**
