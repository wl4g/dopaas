 ...
 */
package com.wl4g.paas.uci.analyses.coordinate;
...
import com.wl4g.paas.uci.analyses.config.ExecutorProperties;
import com.wl4g.paas.uci.analyses.model.AnalysisQueryModel;
import com.wl4g.paas.uci.analyses.model.AnalysisResultModel;
...
public class SpotbugsAnalysisCoordinator extends AbstractAnalysisCoordinator<SpotbugsAnalysingModel> {
	 ...
	 */
	final public static String SPOTBUGS_ENGINE_CLASS = "com.wl4g.paas.uci.analyses.agent.spotbugs.SpotbugsAnalyzerEngine";
