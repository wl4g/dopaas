 ...
 */
package com.wl4g.paas.uci.analyses.config;

import static com.wl4g.paas.common.constant.CiConstants.URL_ANALYZER_BASE_PATH;
...
import com.wl4g.paas.uci.analyses.coordinate.AnalysisCoordinator;
import com.wl4g.paas.uci.analyses.coordinate.SpotbugsAnalysisCoordinator;
import com.wl4g.paas.uci.analyses.model.SpotbugsAnalysingModel;
import com.wl4g.paas.uci.analyses.tasks.DefaultTaskManager;
import com.wl4g.paas.uci.analyses.tasks.TaskManager;
import com.wl4g.paas.uci.analyses.web.CodesAnalyzerController;
...
public class CiAnalyzerAutoConfiguration extends PrefixHandlerMappingSupport {
	...
	public Object codesAnalyzerControllerPrefixHandlerMapping() {
		return super.newPrefixHandlerMapping(URL_ANALYZER_BASE_PATH,
				com.wl4g.paas.uci.analyses.annotation.CodesAnalyzerController.class);
	}
