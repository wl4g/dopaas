 ...
 */
package com.wl4g.paas.uci.config;

import com.wl4g.component.core.framework.beans.NamingPrototype;
import com.wl4g.component.core.framework.operator.GenericOperatorAdapter;
import com.wl4g.paas.uci.console.CiConsole;
import com.wl4g.paas.uci.core.DefaultPipelineManagerImpl;
import com.wl4g.paas.uci.core.PipelineJobExecutor;
import com.wl4g.paas.uci.core.PipelineManager;
import com.wl4g.paas.uci.core.context.PipelineContext;
import com.wl4g.paas.uci.core.orchestration.DefaultOrchestrationManagerImpl;
import com.wl4g.paas.uci.core.orchestration.OrchestrationManager;
import com.wl4g.paas.uci.pcm.PcmOperator;
import com.wl4g.paas.uci.pcm.PcmOperator.PcmKind;
import com.wl4g.paas.uci.pcm.jira.JiraPcmOperator;
import com.wl4g.paas.uci.pcm.redmine.RedminePcmOperator;
import com.wl4g.paas.uci.pipeline.TimeoutJobsEvictor;
import com.wl4g.paas.uci.pipeline.TimingPipelineManager;
import com.wl4g.paas.uci.pipeline.deploy.*;
import com.wl4g.paas.uci.pipeline.provider.*;
import com.wl4g.paas.uci.pipeline.provider.PipelineProvider.PipelineKind;
import com.wl4g.paas.uci.pipeline.provider.container.DockerNativePipelineProvider;
import com.wl4g.paas.uci.pipeline.provider.container.RktNativePipelineProvider;
import com.wl4g.paas.uci.tool.LogPurger;
...
import com.wl4g.paas.common.constant.CiConstants;
