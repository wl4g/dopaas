...
import static com.wl4g.paas.uci.core.orchestration.DefaultOrchestrationManagerImpl.FlowStatus.FAILED;
import static com.wl4g.paas.uci.core.orchestration.DefaultOrchestrationManagerImpl.FlowStatus.RUNNING;
import static com.wl4g.paas.uci.core.orchestration.DefaultOrchestrationManagerImpl.FlowStatus.SUCCESS;
import static com.wl4g.paas.common.constant.CiConstants.LOG_FILE_END;
import static com.wl4g.paas.common.constant.CiConstants.LOG_FILE_START;
import static com.wl4g.paas.common.constant.CiConstants.TASK_STATUS_CREATE;
import static com.wl4g.paas.common.constant.CiConstants.TASK_STATUS_FAIL;
import static com.wl4g.paas.common.constant.CiConstants.TASK_STATUS_PART_SUCCESS;
import static com.wl4g.paas.common.constant.CiConstants.TASK_STATUS_RUNNING;
import static com.wl4g.paas.common.constant.CiConstants.TASK_STATUS_STOP;
import static com.wl4g.paas.common.constant.CiConstants.TASK_STATUS_STOPING;
import static com.wl4g.paas.common.constant.CiConstants.TASK_STATUS_SUCCESS;
...
import com.wl4g.paas.uci.config.CiProperties;
import com.wl4g.paas.uci.core.context.DefaultPipelineContext;
import com.wl4g.paas.uci.core.context.PipelineContext;
import com.wl4g.paas.uci.core.orchestration.OrchestrationManager;
import com.wl4g.paas.uci.data.PipeStageNotificationDao;
import com.wl4g.paas.uci.pipeline.provider.PipelineProvider;
import com.wl4g.paas.uci.service.PipelineHistoryService;
import com.wl4g.paas.uci.service.PipelineService;
import com.wl4g.paas.uci.service.ProjectService;
import com.wl4g.paas.uci.utils.HookCommandHolder.BuildCommand;
...
import com.wl4g.paas.common.bean.uci.ClusterExtension;
import com.wl4g.paas.common.bean.uci.PipeStageBuilding;
import com.wl4g.paas.common.bean.uci.PipeStageBuildingProject;
import com.wl4g.paas.common.bean.uci.PipeStageInstanceCommand;
import com.wl4g.paas.common.bean.uci.PipeStageNotification;
import com.wl4g.paas.common.bean.uci.Pipeline;
import com.wl4g.paas.common.bean.uci.PipelineHistory;
import com.wl4g.paas.common.bean.uci.PipelineHistoryInstance;
import com.wl4g.paas.common.bean.uci.Project;
import com.wl4g.paas.common.bean.uci.model.ActionControl;
import com.wl4g.paas.common.bean.uci.model.PipelineModel;
import com.wl4g.paas.common.bean.uci.param.HookParameter;
import com.wl4g.paas.common.bean.uci.param.RollbackParameter;
import com.wl4g.paas.common.bean.uci.param.RunParameter;
import com.wl4g.paas.common.bean.cmdb.AppCluster;
import com.wl4g.paas.common.bean.cmdb.AppEnvironment;
import com.wl4g.paas.common.bean.cmdb.AppInstance;
import com.wl4g.paas.common.bean.cmdb.DockerRepository;
import com.wl4g.paas.cmdb.service.AppClusterService;
import com.wl4g.paas.cmdb.service.AppInstanceService;
import com.wl4g.paas.cmdb.service.DockerRepositoryService;
