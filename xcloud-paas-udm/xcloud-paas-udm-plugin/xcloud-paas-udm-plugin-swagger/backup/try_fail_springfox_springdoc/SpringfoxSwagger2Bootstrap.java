 ...
 */
package com.wl4g.paas.udm.plugin.swagger.springfox;
...
import static com.wl4g.paas.udm.plugin.swagger.util.SpringUtils.SCAN_BASE_PACKAGES;
//import static com.wl4g.paas.udm.plugin.swagger.springfox.SpringfoxSwagger2Bootstrap.SpringfoxConfigurerExcludeFilter;
//import static com.wl4g.paas.udm.plugin.swagger.springfox.SpringfoxSwagger2Bootstrap.SpringfoxConfigurerIncludeFilter;
...
import com.wl4g.paas.udm.plugin.swagger.util.SpringUtils;
...
@SpringBootApplication(scanBasePackages = "${" + SCAN_BASE_PACKAGES + ":com.wl4g.paas}")
@EnableSwagger2
public class SpringfoxSwagger2Bootstrap {
	...
	// !startsWithAny(className, "com.wl4g.paas")) {
	// return false;
	// }
