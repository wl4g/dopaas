 ...
 */
package com.wl4g.dopaas.uci.pipeline.provider.app;

import com.wl4g.dopaas.uci.core.context.PipelineContext;
import com.wl4g.dopaas.uci.pipeline.provider.RestorableDeployPipelineProvider;
 ...
 * @since
 */
public class IOSPipelineProvider extends RestorableDeployPipelineProvider {

	public IOSPipelineProvider(PipelineContext context) {
		super(context);
	}
