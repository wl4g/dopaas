...
function(require, exports, module) {
	...
	var DocCommentHighlightRules = function() {debugger
		this.$rules = {
			"start": [{
	...
	DocCommentHighlightRules.getTagRule = function(start) {debugger
		return {
	...
	DocCommentHighlightRules.getStartRule = function(start) {debugger
		return {
			token: "comment.doc",
			// doc comment
			regex: "\\/\\*(?=\\*)",
	...
	DocCommentHighlightRules.getEndRule = function(start) {debugger
		return {
			token: "comment.doc",
			// closing comment
			regex: "\\*\\/",
...
function(require, exports, module) {
	...
	var JavaScriptHighlightRules = function(options) {debugger
...
debugger
	...
	function JSX() {debugger
		...
		this.$rules.jsxAttributes = [{
			...
			regex: "/?>",
			onMatch: function(value, currentState, stack) {debugger
...
function(require, exports, module) {
	...
	(function() {
		this.checkOutdent = function(line, input) {debugger
			if (!/^\s+$/.test(line)) return false;
			return /^\s*\}/.test(input);
		};
		this.autoOutdent = function(doc, row) {debugger
...
function(require, exports, module) {debugger
	"use strict";
	...
	var getWrapped = function(selection, selected, opening, closing) {
		var rowDiff = selection.end.row - selection.start.row;debugger
		return {
...
define("ace/mode/javascript", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/javascript_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range", "ace/worker/worker_client", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"],
function(require, exports, module) {
	"use strict";
	...
	var CStyleFoldMode = require("./folding/cstyle").FoldMode;debugger
	...
	(function() {
		...
		this.checkOutdent = function(state, line, input) {
			return this.$outdent.checkOutdent(line, input);debugger
		};
...
define("ace/mode/groovy_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/doc_comment_highlight_rules", "ace/mode/text_highlight_rules"],
function(require, exports, module) {
	"use strict";
...
define("ace/mode/groovy", ["require", "exports", "module", "ace/lib/oop", "ace/mode/javascript", "ace/mode/groovy_highlight_rules"],
function(require, exports, module) {
	"use strict";
