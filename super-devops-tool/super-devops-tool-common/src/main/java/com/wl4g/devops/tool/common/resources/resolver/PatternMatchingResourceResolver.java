...
import com.wl4g.devops.tool.common.resources.FileSystemResource;
import com.wl4g.devops.tool.common.resources.Resource;
import com.wl4g.devops.tool.common.resources.ResourceUtils;
import com.wl4g.devops.tool.common.resources.UrlResource;
import com.wl4g.devops.tool.common.resources.VfsResource;
import com.wl4g.devops.tool.common.resources.VfsUtils;
import com.wl4g.devops.tool.common.resources.match.AntPathMatcher;
import com.wl4g.devops.tool.common.resources.match.PathMatcher;
 ...
 */
public class PatternMatchingResourceResolver implements ResourcePatternResolver {

	private static final Log logger = LogFactory.getLog(PatternMatchingResourceResolver.class);
	...
	static {
		try {
			...
			Class<?> fileLocatorClass = ClassUtils2.forName("org.eclipse.core.runtime.FileLocator",
					PatternMatchingResourceResolver.class.getClassLoader());
	 ...
	 */
	public PatternMatchingResourceResolver() {
	 ...
	 *            resources with
	 */
	public PatternMatchingResourceResolver(ResourceLoader resourceLoader) {
	 ...
	 * @see com.wl4g.devops.tool.common.resources.resolver.springframework.core.io.DefaultResourceLoader
	 */
	public PatternMatchingResourceResolver(ClassLoader classLoader) {
		...
		try {
			...
			for (String path : StringUtils2.delimitedListToStringArray(javaClassPathProperty,
				...
				try {
					...
					UrlResource jarResource = new UrlResource(ResourceUtils.JAR_URL_PREFIX + ResourceUtils.FILE_URL_PREFIX
	...
	private boolean hasDuplicate(String filePath, Set<Resource> result) {
		...
		try {
			return result.contains(new UrlResource(ResourceUtils.JAR_URL_PREFIX + ResourceUtils.FILE_URL_PREFIX + duplicatePath
	 ...
	 * @since 3.0.3
	 */
	abstract static class VfsPatternUtils extends VfsUtils {
