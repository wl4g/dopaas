 ...
 * @since
 */
final public class RsaKeySpecEntity extends KeySpecEntity {
	...
	public RsaKeySpecEntity(String algorithm, KeySpec pubKeySpec, KeySpec keySpec) {
	...
	public RsaKeySpecEntity(String keySpecId, String algorithm, KeySpec pubKeySpec, KeySpec keySpec) {
		super(keySpecId);
		Assert2.notNull(algorithm, "'algorithm' must not be null");
		Assert2.notNull(pubKeySpec, "'publicKeySpec' must not be null");
		Assert2.notNull(keySpec, "'privateKeySpec' must not be null");
