 ...
 */
public abstract class CrypticUtils {
	...
	public static class RSA1 {
		final private static int KEY_SIZE_BITS = 1024;
		...
		public RSA1() throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException,
