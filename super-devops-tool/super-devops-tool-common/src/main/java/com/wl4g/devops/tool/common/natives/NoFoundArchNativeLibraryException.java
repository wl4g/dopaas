...
public class NoFoundArchNativeLibraryException extends RuntimeException {
	 ...
	 * to {@link #initCause}.
	 */
	public NoFoundArchNativeLibraryException() {
		super();
	}
	 ...
	 */
	public NoFoundArchNativeLibraryException(String message) {
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public NoFoundArchNativeLibraryException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @since 1.4
	 */
	public NoFoundArchNativeLibraryException(Throwable cause) {
		super(cause);
	}
}