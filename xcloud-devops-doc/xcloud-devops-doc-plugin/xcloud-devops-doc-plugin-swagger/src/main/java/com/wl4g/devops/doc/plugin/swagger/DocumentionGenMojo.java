...
import com.wl4g.devops.doc.plugin.swagger.export.SpringfoxSwagger2DocExporter;
 ...
 * @see
 */
@Mojo(name = "gendoc", defaultPhase = LifecyclePhase.GENERATE_SOURCES, configurator = "include-project-dependencies", requiresDependencyResolution = ResolutionScope.COMPILE_PLUS_RUNTIME, threadSafe = true)
public class DocumentionGenMojo extends AbstractMojo {
	...
	protected void doExecute() {
		Object documention = new SpringfoxSwagger2DocExporter(getLog()).export();
