 ...
 * @since v1.0
 */
public interface EnterpriseOas3ApiDao {

    int insertSelective(EnterpriseOas3Api enterpriseOas3Api);
    ...
    List<EnterpriseOas3Api> list(@Param("enterpriseOas3Api") EnterpriseOas3Api enterpriseOas3Api);
