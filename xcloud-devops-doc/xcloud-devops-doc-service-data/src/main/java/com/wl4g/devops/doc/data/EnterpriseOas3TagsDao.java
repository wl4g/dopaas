 ...
 * @since v1.0
 */
public interface EnterpriseOas3TagsDao {

    int insertSelective(EnterpriseOas3Tags enterpriseOas3Tags);
    ...
    List<EnterpriseOas3Tags> list(@Param("enterpriseOas3Tags") EnterpriseOas3Tags enterpriseOas3Tags);
