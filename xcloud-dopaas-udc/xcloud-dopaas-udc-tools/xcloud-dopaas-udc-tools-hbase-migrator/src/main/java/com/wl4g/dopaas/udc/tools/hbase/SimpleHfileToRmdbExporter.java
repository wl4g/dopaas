 ...
 */
package com.wl4g.dopaas.udc.tools.hbase;

import static com.wl4g.dopaas.udc.tools.hbase.utils.HbaseMigrateUtils.DEFAULT_HBASE_MR_TMPDIR;
import static com.wl4g.dopaas.udc.tools.hbase.utils.HbaseMigrateUtils.DEFAULT_HFILE_OUTPUT_DIR;
import static com.wl4g.dopaas.udc.tools.hbase.utils.HbaseMigrateUtils.DEFAULT_SCAN_BATCH_SIZE;
import static com.wl4g.dopaas.udc.tools.hbase.utils.HbaseMigrateUtils.DEFUALT_COUNTER_GROUP;
import static com.wl4g.dopaas.udc.tools.hbase.utils.HbaseMigrateUtils.DEFUALT_COUNTER_PROCESSED;
import static com.wl4g.dopaas.udc.tools.hbase.utils.HbaseMigrateUtils.DEFUALT_COUNTER_TOTAL;
...
import com.wl4g.dopaas.udc.tools.hbase.mapred.SimpleHfileToRmdbMapper;
import com.wl4g.dopaas.udc.tools.hbase.rmdb.RmdbMigrateManager;
...
public class SimpleHfileToRmdbExporter {
	 ...
	 * 
	 * <pre>
	 * java -cp xcloud-dopaas-udc-tools-hbase-migrator-master.jar \
