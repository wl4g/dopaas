...
return b||a},q=function(a){a=Object.assign({serverPort:8080,serverNameForSubLevelDomain:"iam"},a);var b=location.hostname,c=a.serverPort?a.serverPort:location.port,e=location.protocol;if(p(b)||"localhost"==b||"127.0.0.1"==b||"0:0:0:0:0:0:0:1"==b||b.endsWith(".debug")||b.endsWith(".local")||b.endsWith(".dev"))return e+"//"+b+":"+c;c=b.split(".").slice(-2).join(".");0<b.indexOf("com.cn")&&(c=b.split(".").slice(-3).join("."));return e+"//"+a.serverNameForSubLevelDomain+"."+c},u=function(a){for(m in f.modules){var b=
f.modules[m];if(a==b.modName)return b}},r=function(a){for(var b=[],c=0;c<f.dependencies.length;c++){for(var e=!1,d=0;d<f.dependencies[c].features.length;d++)if(f.dependencies[c].features[d]==a){e=!0;break}if(e)for(e=0;e<f.dependencies[c].depends.length;e++)d=u(f.dependencies[c].depends[e]),b.push(d)}a=[];if(b&&0<b.length){a=[b[0]];for(c=1;c<b.length;c++){e=!1;for(d=0;d<a.length;d++)if(b[c].stable==a[d].stable||b[c].grey==a[d].grey){e=!0;break}e||a.push(b[c])}a.sort(function(a,b){return a.ratio-b.ratio})}return 0==
a.length?null:{modules:a}},v=function(a){var b=k.location.pathname;a||(a="./");if(0<=a.indexOf("././"))throw Error("Illegal path '"+a+"'");if(a.startsWith("./"))return b.substring(0,b.lastIndexOf("/"))+a.substring(a.indexOf("./")+2);if(a.startsWith("../")){var c=a.split("../");a="";var e=0,d;for(d in c)""==c[d]?e+=1:a+=c[d]+"/";b=b.split("/");d="";for(c=0;c<b.length-e-1;c++)d+=b[c]+"/";return d+a}return a},h=function(){var a={path:"",cache:"false",mode:"stable",refreshLevel:"yyMMddhh"},b,c=k.getElementsByTagName("script"),
c=c[c.length-1];if(c=k.currentScript||c){if(b=c.getAttribute("src")){var e=b.split("/");if(b.toLocaleUpperCase().startsWith("HTTP")){b="";for(var d=0;d<e.length;d++)d<e.length-2&&(b+=e[d]+"/");b.substring(0,b.length-1)}}b=c.getAttribute("fileUriPort");d=c.getAttribute("fileUriDomainSubLevel");e=c.getAttribute("path")||a.path;e.toUpperCase().startsWith("HTTP://")||e.toUpperCase().startsWith("HTTPS://")?a.path=e:(b=q({serverPort:b,serverNameForSubLevelDomain:d}),a.path=b+v(e));a.cache=c.getAttribute("cache")||
