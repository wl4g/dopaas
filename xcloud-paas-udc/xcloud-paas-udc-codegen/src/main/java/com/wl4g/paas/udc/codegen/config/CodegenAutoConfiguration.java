...
import com.wl4g.paas.common.constant.DTSConstants;
import com.wl4g.paas.udc.codegen.bean.GenDataSource;
import com.wl4g.paas.udc.codegen.console.CodegenConsole;
import com.wl4g.paas.udc.codegen.engine.DefaultGenerateEngineImpl;
import com.wl4g.paas.udc.codegen.engine.context.GenerateContext;
import com.wl4g.paas.udc.codegen.engine.generator.AngularJSGeneratorProvider;
import com.wl4g.paas.udc.codegen.engine.generator.CsharpStandardGeneratorProvider;
import com.wl4g.paas.udc.codegen.engine.generator.GoGonicWebGeneratorProvider;
import com.wl4g.paas.udc.codegen.engine.generator.PythonStandardGeneratorProvider;
import com.wl4g.paas.udc.codegen.engine.generator.SpringDubboMvnGeneratorProvider;
import com.wl4g.paas.udc.codegen.engine.generator.IamSpringCloudMvnGeneratorProvider;
import com.wl4g.paas.udc.codegen.engine.generator.IamVueGeneratorProvider;
import com.wl4g.paas.udc.codegen.engine.resolver.MetadataResolver;
import com.wl4g.paas.udc.codegen.engine.resolver.db.MySQLV5MetadataResolver;
import com.wl4g.paas.udc.codegen.engine.resolver.db.OracleV11gMetadataResolver;
import com.wl4g.paas.udc.codegen.engine.resolver.db.PostgreSQLV10MetadataResolver;
import com.wl4g.paas.udc.codegen.engine.template.ClassPathGenTemplateLocator;
import com.wl4g.paas.udc.codegen.engine.template.GenTemplateLocator;
...
import static com.wl4g.paas.udc.codegen.engine.generator.GeneratorProvider.GenProviderAlias.*;
import static com.wl4g.paas.udc.codegen.engine.resolver.MetadataResolver.ResolverAlias.*;
