...
//
/// **
// * Note: Don't remove the final, if anyone extends this class, bad things
// could
// * happen, since a thread is started in this class's constructor. Creating an
// * instance of this class runs a FindBugs analysis, and pops up a nice
// progress
// * window.
// *
...
// */
// private DefaultAnalyzingProgress(@Nonnull Project project, AnalysisCallback
// callback, boolean joinThread) {
...
// @Override
// public void run() {
// DefaultAnalyzingProgress progress = new DefaultAnalyzingProgress(project,
// callback, joinThread);
...
// updateStage(edu.umd.cs.findbugs.L10N.getLocalString("progress.finishing_analysis",
// "Finishing analysis..."));
// }
//
// @Override
// public void reportNumberOfArchives(int numArchives) {
// updateStage(edu.umd.cs.findbugs.L10N.getLocalString("progress.scanning_archives",
// "Scanning archives..."));
...
// pass++;
// String localString =
// edu.umd.cs.findbugs.L10N.getLocalString("progress.analyzing_classes",
// "Analyzing classes...");
...
// callback.analysisInterrupted();
// scheduleErrorDialog("Analysis failed", e.getClass().getSimpleName() + ": " +
// e.getMessage());
// return;
// } catch (Throwable e) {
// callback.analysisInterrupted();
