...
/**
 * Based physical host pipeline provider.
 * 
 * @author Wangl.sir <wanglsir@gmail.com, 983708408@qq.com>
 * @version v1.0 2019年10月12日
 * @since
 */
public abstract class BasedHostPipelineProvider extends GenericDependenciesPipelineProvider {

	public BasedHostPipelineProvider(PipelineContext context) {
		super(context);
	}
