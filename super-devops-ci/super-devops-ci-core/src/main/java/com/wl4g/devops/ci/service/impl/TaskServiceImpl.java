...
public class TaskServiceImpl implements TaskService {
	...
	@Override
	public List<TaskBuildCommand> getDependency(Integer appClusterId, Integer taskId, Integer tarOrBranch) {
		Project project = projectDao.getByAppClusterId(appClusterId);
		if (project == null) {
		...
		for (Dependency dependency : dependencys) {
			...
			List<String> branchs = projectService.getBranchsByProjectId(taskBuildCommand.getProjectId(), tarOrBranch);
