 ...
 * @since
 */
public class MvnAssembleTarPipelineHandler extends BasedPipelineHandler {
	...
	public MvnAssembleTarPipelineHandler(MvnAssembleTarPipelineProvider provider, Project project, String path, AppInstance instance,
