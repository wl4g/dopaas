...
import com.wl4g.devops.ci.pmplatform.PcmPlatformHandle;
...
public class PcmController {
    ...
    @Autowired
    private PcmPlatformHandle pcmPlatformHandle;
    ...
    public RespBase<?> getUsers(Integer taskId){
        ...
        List<SelectInfo> selectInfos = pcmPlatformHandle.getUsers(taskId);
    ...
    public RespBase<?> getProjects(Integer taskId){
        RespBase<Object> resp = RespBase.create();
        List<SelectInfo>  selectInfos = pcmPlatformHandle.getProjects(taskId);
        resp.setData(selectInfos);
        return resp;
    }
    ...
    public RespBase<?> getIssues(Integer taskId,String userId, String projectId,String search){
        RespBase<Object> resp = RespBase.create();
        List<SelectInfo>  selectInfos = pcmPlatformHandle.getIssues(taskId,userId,projectId,search);
        resp.setData(selectInfos);
        return resp;
    }
