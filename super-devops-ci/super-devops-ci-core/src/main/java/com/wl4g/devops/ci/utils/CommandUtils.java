...
public abstract class CommandUtils {
	...
	public static void exec(String cmd, String dirPath,String logPath,Integer taskId)
			throws Exception {
	...
	public static void main(String[] args) throws Exception {
		Process ps = Runtime.getRuntime().exec(new String[] { "/bin/bash", "-c", "sh /Users/vjay/Downloads/myTest.sh 2>&1 | tee -a /Users/vjay/Downloads/zz.log"});
