...
public class ConfigCenterController {
	...
	public RespBase<List<CenterConfig>> loadConfigs() {
		return RespBase.<List<CenterConfig>> create()
				.withData(centerConfigService.loadAll(OrchestrationType.CONFIG_CENTER.getValue()).getCenterConfigs());
	}
	...
	public RespBase<Boolean> connect(@RequestBody final CenterConfig config) {
		CenterRepositoryFactory
				.createConfigCenter(centerConfigService.load(config.getName(), OrchestrationType.CONFIG_CENTER.getValue()));
	...
	public RespBase<CenterConfig> activated() {
		return RespBase.<CenterConfig> create()
				.withData(centerConfigService.loadActivated(OrchestrationType.CONFIG_CENTER.getValue()).orElse(null));
	}
